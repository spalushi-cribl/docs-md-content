...
- For an on-prem Worker Node configure a Filesystem Collector to send data to the Cribl HTTP Destination, and from there to the Cribl HTTP Source in Cribl.Cloud.
