...
**Port**: By default, OTel applications send output to port `4317`. Do not change this setting unless you want Cribl Stream to collect data from an OTel application that is using a different port.
