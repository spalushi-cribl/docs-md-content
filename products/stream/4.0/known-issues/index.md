...
**Fix**: Planned for Cribl Stream 4.2.
...
### 2023-02-20 v.4.0.3–4.0.4 – On-prem Worker Nodes automatically upgrade, ignoring Leader settings [CRIBL‑15367]

**Problem**: Upgrading a Leader Node causes its on-prem Worker Nodes to automatically upgrade, even when the Leader's **Enable automatic upgrades** option is set to `No` (the default). This problem does not affect Cribl-managed Cloud Worker Nodes.
...
**Fix**: Planned for Cribl Stream 4.3.
...
### 2022-12-15 v.3.5.4–4.0.2 – Changes to a Lookup table on the Leader don't always propagate to Worker Nodes [CRIBL-14299] 
...
### 2022-11-28 – v.4.0.1 – Diag bundles might fail to download from teleported Worker Nodes [CRIBL-13999] 
...
### 2022-11-23 – v.4.0 – Teleported Worker Nodes don't display Distributed Settings or Diagnostics Settings [CRIBL‑13868]
...
### 2022-11-03 – v.4.0 – Sorting by column on Manage > Worker Node page results in blank list [CRIBL‑13505]
