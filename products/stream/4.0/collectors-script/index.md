...
From the top nav, click **Manage**, then select a **Worker Group** to configure. Next, select **Data** > **Sources**, then select **Collectors** > **Script** from the **Manage Sources** page's tiles or left nav. Click **New Collector** to open the **Script** > **New Collector** modal, which provides the following options and fields.
