...
From the top nav of a Cribl Stream instance or Group, select **Data** > **Sources**, then select **Collectors** > **REST** from the **Data Sources** page's tiles or the **Sources** left nav. Click **New Collector** to open the **REST** > **New Collector** modal. Enter a **Collector ID**, then complete the following options and fields.
...
![Discover Settings](st-lacework-api01.ed3fb2468f.png)
{border="true"}
...
![Adding a Collect header](st-lacework-api07.2b0b394418.png)
{border="true"}
...
![Data from the Lacework API](st-lacework-api04.449d9efc6f.png)
{border="true"}
