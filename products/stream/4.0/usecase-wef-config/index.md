...
In the **QuickConnect** UI: Click **New Source**, or click **+ Add** beside **Sources**. From the resulting drawer's tiles, select [**Push** >] **Windows Event Forwarder**. Next, click either **+ Add Destination** or (if displayed) **Select Existing** to open a Windows Event Forwarder Source drawer.
...
![Configuring Advanced Settings](st-wef-cloud10.e94490b920.png)
...
![Configuring Subscriptions](st-wef-cloud11.aa3338422d.png)
