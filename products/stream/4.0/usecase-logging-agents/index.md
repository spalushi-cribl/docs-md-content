...
Cribl recommends setting an authorization token so that your receiver will accept only your traffic. This [setting](sources-splunk#auth-tokens) is in Cribl Stream's
**Sources** > **Splunk TCP** > **Auth Tokens** tab.
