...
Cribl Stream supports receiving data from [Amazon S3](https://aws.amazon.com/s3/) buckets, using [event notifications](https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html) through SQS.
...
* If you're having connectivity issues, but no problems with the CLI, see if the [AWS CLI proxy](https://docs.aws.amazon.com/cli/latest/userguide/cli-configure-proxy.html) is in use. Check with your administrator for details.
