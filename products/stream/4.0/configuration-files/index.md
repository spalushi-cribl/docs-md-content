...
- Worker Nodes  will temporarily disappear from the Leader’s Manage/Worker Node page.
- Aggregations and suppressions will start over.
- The local copy of monitoring metrics on the Worker Nodes, before the restart, will be dropped.
...
- Mode of operation (Leader, distributed Worker Node, Single-instance)
- Worker Group assignment
- Event Breakers
- Quick Connects
- Sources
- Destinations
- Group Settings > API Server Settings: TLS, Advanced
