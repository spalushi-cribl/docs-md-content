...
If messages sent to the Source **are** RFC-compliant, fields that the RFC deems guaranteed will always be there; but fields deemed optional might or might not be. Once Cribl Stream parses the required fields and any optional fields, what remains is the actual message.
