...
The editor provides autocompletion and validation to guide you. (With deeply nested schemas, Cribl Stream does not yet fully support autocompletion, and v.4.0.3 or later is required for full validation support.)
