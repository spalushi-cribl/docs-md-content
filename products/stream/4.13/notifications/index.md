...
- **Internal logs:** Cribl Stream stores these application-wide logs in the `notifications.log` file on the Leader Node, which also handles sending all Notifications. See [Internal Logs](internal-logs) for more information about logs.
...
1. Navigate to your Worker Group. Then select **Data** > **Sources**.
...
1. Navigate to your Worker Group. Then select **Data** > **Destinations**.
