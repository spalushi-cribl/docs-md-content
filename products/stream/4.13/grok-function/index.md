...
You can add and edit Grok patterns via Cribl Stream's UI by selecting **Knowledge > [Grok Patterns](grok-patterns-library)**. Pattern files are located at: `$CRIBL_HOME/(default|local)/cribl/grok-patterns/` 
