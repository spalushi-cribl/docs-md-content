...
If you have multiple instances of Cribl Stream on-prem, you're likely managing
...
the [FinOps Center](cloud-billing) to get a unified, all-product view of your Cribl Stream usage
and spending.
...
- Create a billing- and usage-based connection between the Cribl Stream on-prem
...
>Full access to Connected Environments requires you to upgrade Cribl Stream to 4.8.2 or newer.
{.box .warning}
...
and credit consumption for your on-prem and Cloud deployments of Cribl Stream. You
...
1. In the sidebar, select **Organization**, then **FinOps Center**.
1. On the **FinOps Center** submenu, select **Plan and Invoices**.
1. In **Monthly Usage History**, expand the **Billing Date** and scroll to the
   **Connected Environments** table.
...
- The Distributed deployment on-prem Leader must be running Cribl Stream 4.8.2 or newer.
