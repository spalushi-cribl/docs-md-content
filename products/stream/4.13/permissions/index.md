...
Assign Organization-level Permissions per individual user when you [invite them](members#invite-members) to your Organization as Members or by updating an existing user's assigned **Organization Permissions** after they join.

If you [configured SSO](sso-initial-steps), grant Organization-level Permissions by managing group membership within your IdP. Make sure that your IdP group names align with the core patterns for [automatic Permission mapping](sso-initial-steps#idp-group-name-mapping).
