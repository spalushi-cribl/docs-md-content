...
The Chain Function includes guardrails against circular references. In v.4.3 and newer, Cribl Stream detects cycles when you configure your Pipeline. This early detection (compared to older versions' runtime detection) means that:
