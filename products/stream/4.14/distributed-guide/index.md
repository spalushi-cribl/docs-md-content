...
To verify the whole configuration you've created, in the sidebar, select **Monitoring**. On the **Monitoring** page, use the **All Worker Groups** drop-down (upper right) to toggle between the two Worker Groups to see the division of labor:
