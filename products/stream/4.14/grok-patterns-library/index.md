...
You can access the Grok Patterns Library by selecting **Worker Groups** from the sidebar and choosing a Worker Group.
Then, on the **Worker Groups** submenu, select **Processing**, then **Knowledge**, then **Grok Patterns**.
...
In the current Cribl Stream version, you apply Grok patterns by inserting a [Grok Function](grok-function) into a Pipeline, then manually typing or pasting patterns into the **Pattern** field(s).
