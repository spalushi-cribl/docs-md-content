...
> 
> In Cribl Stream 4.2 and newer, Projects/Subscriptions rely entirely on the fine-grained [Members/Permissions](/stream/members) access control first introduced in Stream 4.2. See [Adding Users to Projects](/stream/sharing-projects) for details.
>
{.box .warning}
...
Enabling Projects requires an Enterprise plan or on-prem license. For details, see [Pricing](https://cribl.io/pricing/).
...
![How Subscriptions and Projects filter incoming data](projects-isometric-4.12.png)
{border="false"}

## Get Started with Projects {#start}
...
2. Select **Projects** in the submenu to see two menu options: **Data Projects** and **Subscriptions**.
