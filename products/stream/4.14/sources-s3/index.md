...
1. If needed, configure the **AssumeRole** settings. You can use these settings to access resources in a different Region than Cribl Stream. See [Assume Role Settings](#assume) for more information.
...
[Snippet not found: content/shared/4.14/snippets/_common-errors-aws-sources.md]
