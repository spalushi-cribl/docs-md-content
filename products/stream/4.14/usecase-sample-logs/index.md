...
Though not always the easiest, this is the best option, because samples are captured exactly as they will look when handed off to Cribl Stream in production. You'll set Cribl Stream up as a [passthrough](aggregations-function#output-settings) which gets samples “right off the wire” and dumps them to [DevNull](destinations#internal-destinations).
...
![The **Live** button initiates capture](st-sample-logs-01.3b0351525a.png)
{border="true"}
