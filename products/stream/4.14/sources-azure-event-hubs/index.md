...
**Validate server certs**: Whether to reject connections to servers without signed certificates. Defaults to toggled on.
...
**Minimize duplicates**: Toggle on to start only one consumer for each topic partition (optional). This reduces duplicates.
