...
> If you are creating a Trust Relationship for a [Cribl.Cloud](deploy-cloud) Worker managed by Cribl, you would instead paste the AWS Worker's role ARN in the format shown below. This option applies only to Cribl-managed Workers, not to customer-managed (hybrid or on-prem) Workers:
>
{.box .success}
...
> If you are creating a Trust Relationship for a Cribl-managed [Cloud](deploy-cloud) Worker, skip this section. Cribl has implicitly preconfigured Account A for you.
>
{.box .success}
...
![Cribl Stream Assume Role configuration](aws-collector-config-assume-role-4101.png)
{border="true"}
