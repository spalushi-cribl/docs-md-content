...
`ipfix-information-elements.yml` contains predefined IPFIX fields derived from the [IANA IPFIX Information Elements](https://www.iana.org/assignments/ipfix/ipfix.xhtml) list. This file ensures that Cribl Stream can handle and decode IPFIX fields effectively from the [NetFlow & IPFIX Source](sources-netflow).
