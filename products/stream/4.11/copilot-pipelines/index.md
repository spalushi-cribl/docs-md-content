...
* **Ask questions.** Use the Cribl Copilot [chatbot](/copilot/copilot-chat/) to answer general questions about Pipelines. For example, you could ask the chatbot, `What Pipeline Functions can I use to redact sensitive information like IP addresses?`
