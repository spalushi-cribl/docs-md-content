...
On customer-managed (hybrid or on-prem) Worker Groups and on all Edge Nodes, you can freely define the **Queue size limit**, based on the disk space you provision.
