...
[**Max number of connections**](group-settings#redis-connections-limit) is the upper limit of connections to Redis that Cribl Stream can establish before starting to reuse them.
