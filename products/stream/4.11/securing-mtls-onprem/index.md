...
![Configuring mutual authentication](worker-to-leader-mutual-tls-4101.png)
{border="true"}
...
To set up mTLS authentication via the Worker Node's  `instance.yml` config file, you need to change some values and also add a few keys, as shown in this example:
