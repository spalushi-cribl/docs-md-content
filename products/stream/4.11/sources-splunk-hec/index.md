...
3. Next, you can configure the following **Optional Settings**:
    ...
    - **Splunk HEC acks**: Whether to enable Splunk HEC acknowledgments. Default is toggled off. See [Working with HEC Acks](#acks) below to learn about context and limitations.
...
> With a Cribl.Cloud Enterprise plan, generalize the above URL's `default.main` substring to <NOBR>`<group-name>.<workspaceID>`</nobr> when sending to other Worker Groups and/or Workspaces.
>
{.box .info}
