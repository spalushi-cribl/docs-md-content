...
**Enable for S3**: Whether to use Assume Role credentials to access S3. Defaults to toggled on.

**Enable for SQS**: Whether to use Assume Role credentials when accessing SQS. Default is toggled off.
...
[Snippet not found: content/shared/4.11/snippets/_common-errors-aws-sources.md]
