...
1. In the **Audience (SP entity ID)** field, enter the base URL of your Cribl Stream instance (for example, `https://yourDomain.com:9000`). Do not append a trailing slash, and make sure that your URL uses the HTTPS protocol.
...
## Map Ping Identity Groups to Cribl Stream Roles {#map-groups-to-roles}
