...
> This Function was deprecated as of Cribl Stream 3.0, and has been removed from Cribl Stream as of v.4.0. Please instead use the [Prometheus Destination](destinations-prometheus) to send metrics to Prometheus-compatible endpoints.
>
{.box .warning}
