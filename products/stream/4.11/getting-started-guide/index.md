...
1. Leave **Enable Expression** toggled off (default).
   ...
   > Toggle **Enable Expression** on to change the **Output** field to an **Output Expression** field where you can enter a JavaScript expression for your **Destination** name.
   >
   {.box .info}
...
1. With the Route configured, you now need to move the Route so that it processes events first. Select the drag handle for this Route and drag it above the `default` Route.
   ...
   ![Move the Route](tutorial-route-move-4101.png)
   {border="true"}
