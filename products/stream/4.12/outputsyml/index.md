...
outputs: # [object] 
  ...
  webhook_output: # [object] 
    ...
    maxPayloadSizeKB: # [number] Body size limit (KB) - Maximum size, in KB, of the request body.
    ...
    pqMaxSize: # [string] Queue size limit - The maximum amount of disk space the queue is allowed to consume. Once reached, the system stops queueing and applies the fallback Queue-full behavior. Enter a numeral with units of KB, MB, etc.
  ...
  filesystem_output: # [object] 
    ...
    maxFileSizeMB: # [number] File size limit (MB) - Maximum uncompressed output file size. Files of this size will be closed and moved to final output location.
    maxFileOpenTimeSec: # [number] File open time limit (Sec) - Maximum amount of time to write to a file. Files open for longer than this will be closed and moved to final output location.
    maxFileIdleTimeSec: # [number] Idle time limit (Sec) - Maximum amount of time to keep inactive files open. Files open for longer than this will be closed and moved to final output location.
    maxOpenFiles: # [number] Open file limit - Maximum number of files to keep open concurrently. When over, the oldest open files will be closed and moved to final output location.
  ...
  kinesis_output: # [object] 
    ...
    maxRecordSizeKB: # [number] Record size limit (KB, uncompressed) - Maximum size (KB) of each individual record before compression. For non-compressible data 1MB is the max recommended size
    flushPeriodSec: # [number] Flush period (sec) - Maximum time between requests. Small values could cause the payload size to be smaller than the configured Record size limit.
    onBackpressure: # [string] Backpressure behavior - Whether to block, drop, or queue events when all receivers are exerting backpressure.
  ...
  azure_eventhub_output: # [object] 
    ...
    maxRecordSizeKB: # [number] Record size limit (KB, uncompressed) - Maximum size (KB) of each record batch before compression. Setting should be < message.max.bytes settings in Event Hubs brokers.
    flushEventCount: # [number] Events-per-batch limit - Maximum number of events in a batch before forcing a flush.
    flushPeriodSec: # [number] Flush period (sec) - Maximum time between requests. Small values could cause the payload size to be smaller than the configured Record size limit.
  ...
  google_pubsub_output: # [object] 
    ...
    maxQueueSize: # [number] Queue size limit - Maximum number of queued batches before blocking.
    maxRecordSizeKB: # [number] Max batch size (KB) - Maximum size (KB) of batches to send.
    maxInProgress: # [number] Concurrent request limit - The maximum number of in-progress API requests before backpressure is applied.
    onBackpressure: # [string] Backpressure behavior - Whether to block, drop, or queue events when all receivers are exerting backpressure.
  ...
  kafka_output: # [object] 
    ...
    maxRecordSizeKB: # [number] Record size limit (KB, uncompressed) - Maximum size (KB) of each record batch before compression. Setting should be < message.max.bytes settings in Kafka brokers.
    flushEventCount: # [number] Events-per-batch limit - Maximum number of events in a batch before forcing a flush.
    flushPeriodSec: # [number] Flush period (sec) - Maximum time between requests. Small values could cause the payload size to be smaller than the configured Record size limit.
  ...
  sqs_output: # [object] 
    ...
    assumeRoleExternalId: # [string] External ID - External ID to use when assuming role
    maxQueueSize: # [number] Queue size limit - Maximum number of queued batches before blocking.
    maxRecordSizeKB: # [number] Record size limit (KB) - Maximum size (KB) of batches to send. Per the SQS spec, the max allowed value is 256 KB.
    flushPeriodSec: # [number] Flush period (sec) - Maximum time between requests. Small values could cause the payload size to be smaller than the configured Record size limit.
  ...
  grafana_cloud_output: # [object] 
    ...
    maxPayloadSizeKB: # [number] Body size limit (KB) - Maximum size, in KB, of the request body. Warning: Setting this too low can increase the number of ongoing requests (depending on the value of 'Request concurrency'); this can cause Loki and Prometheus to complain about entries being delivered out of order.
    ...
    rejectUnauthorized: # [boolean] Validate server certs - Reject certs that are not authorized by a CA in the CA certificate path, or by another trusted CA (e.g., the system's CA). Defaults to Yes.
    timeoutSec: # [number] Request timeout - Amount of time, in seconds, to wait for a request to complete before aborting it.
    flushPeriodSec: # [number] Flush period (sec) - Maximum time between requests. Small values could cause the payload size to be smaller than the configured Maximum time between requests. Small values can reduce the payload size below the configured 'Record size limit' and 'Events-per-request limit'. Warning: Setting this too low can increase the number of ongoing requests (depending on the value of 'Request concurrency'); this can cause Loki and Prometheus to complain about entries being delivered out of order.
    extraHttpHeaders: # [array] Extra HTTP headers - Extra HTTP headers.
      - name: # [string] Name - Field name
        value: # [string] Value - Field value
    useRoundRobinDns: # [boolean] Round-robin DNS - Enable to use round-robin DNS lookup. When a DNS server returns multiple addresses, this will cause Stream to cycle through them in the order returned.
  ...
  loki_output: # [object] 
    ...
    maxPayloadSizeKB: # [number] Body size limit (KB) - Maximum size, in KB, of the request body. Warning: Setting this too low can increase the number of ongoing requests (depending on the value of 'Request concurrency'); this can cause Loki to complain about entries being delivered out of order.
    ...
    rejectUnauthorized: # [boolean] Validate server certs - Reject certs that are not authorized by a CA in the CA certificate path, or by another trusted CA (e.g., the system's CA). Defaults to No.
    timeoutSec: # [number] Request timeout - Amount of time, in seconds, to wait for a request to complete before aborting it.
    flushPeriodSec: # [number] Flush period (sec) - Maximum time between requests. Small values could cause the payload size to be smaller than the configured Maximum time between requests. Small values can reduce the payload size below the configured 'Record size limit' and 'Events-per-request limit'. Warning: Setting this too low can increase the number of ongoing requests (depending on the value of 'Request concurrency'); this can cause Loki to complain about entries being delivered out of order.
    extraHttpHeaders: # [array] Extra HTTP headers - Extra HTTP headers.
      - name: # [string] Name - Field name
        value: # [string] Value - Field value
    useRoundRobinDns: # [boolean] Round-robin DNS - Enable to use round-robin DNS lookup. When a DNS server returns multiple addresses, this will cause Stream to cycle through them in the order returned.
