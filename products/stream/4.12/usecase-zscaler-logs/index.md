...
For Zscaler Cloud NSS, use the [Zscaler Cloud NSS Source](sources-zscaler-hec), which uses HTTP/HTTPS.
...
![Parsing with a Code Function](st-zscaler-03-4101.png)
{border="true"}

An [Eval Function](eval-function) reshapes the data:

![Reshaping with Eval](st-zscaler-04-4101.png)
{border="true"}

And finally, a [Serialize Function](serialize-function) drops unwanted fields:

![Dropping fields with Serialize](st-zscaler-05-4101.png)
{border="true"}
