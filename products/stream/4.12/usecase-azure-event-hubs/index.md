...
### Restricting Public Network Access for Cribl.Cloud Deployments {#public-network}
...
1. In the Azure Event Hubs environment, select **Networking** > **Public network access** > **Selected networks**.

1. On that same page, paste the Cribl.Cloud egress IP into the **Address range** field in the Event Hubs environment.
...
2.  In the **General Settings** tab, enter the following values:
    ...
    - **Input Id**: A unique ID of your choice. For example: `Stream`.
...
![The General Settings tab](st-uc-azure-event-hubs04-4101.png)
{border="true"}
...
![The Authentication tab](st-uc-azure-event-hubs05-4101.png)
{border="true"}
