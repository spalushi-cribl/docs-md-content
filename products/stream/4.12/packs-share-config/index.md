...
between Worker Groups and deployments.
...
1. In the sidebar, select **Worker Groups**, then select a Worker Group.
1. On the **Worker Groups** submenu, select **Processing**, then **Routes**.
...
> as well as System Metrics, Windows Metrics, System State, Windows Event Logs,
> K8s Metrics, K8s Logs, K8s Events, and Cribl Internal Sources in Cribl Edge.
{.box .info}
...
> Knowledge Objects such as variables, Regexes, or Event Breaker Rules.
{.box .info}
