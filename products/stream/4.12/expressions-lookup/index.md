...
>
> Cribl Stream 4.1 and newer support returning all columns from a matched row. Use the empty-array convention shown in the above examples: `.match('someValue',[])`.
>
{.box .warning}
