...
If you have an on-prem Cribl Stream environment and a Cribl.Cloud account on
...
select an on-prem Leader that is running Cribl Stream 4.8.2 or newer, then use the
following steps.
