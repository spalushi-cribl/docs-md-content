...
sing Pipelines](#adding-process-pipelines) section.
...
![Routes page in the Cribl Pack for Syslog Input](syslog-usecase_12.6a9c7aac4f.png)
...
![Example of Routes in a Group, each tied to the same sender](syslog-usecase_11.99864d7142.png)
