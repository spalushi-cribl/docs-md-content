...
- The [Amazon Kinesis Streams Source](sources-kinesis-streams) will not perform checksums and the **Verify KPL checksums** setting will not be available.
