...
- [Parquet schemas](#parquet-schemas) for writing data from a Cribl Stream Destination to Parquet files. This page outlines how to manage these in the UI at **Knowledge** > **Parquet Schemas**.
