...
- Permissions problem writing to the staging directory – i.e., the user running the Cribl Stream
...
- Write timeout, where a Source sends data but doesn't receive an `ack` at the TCP
 layer. In this case, Cribl Stream closes the connection to the Destination and tries to re-establish it. 
