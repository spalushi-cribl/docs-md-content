...
For example, if you plan to call the [Audit Logs API](https://docs.microsoft.com/en-us/graph/api/resources/directoryaudit?view=graph-rest-1.0) (as demonstrated in this walkthrough), do the following: <!-- anything rebranded in the URL above? ->
