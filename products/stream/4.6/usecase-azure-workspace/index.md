...
To send data to custom tables from Cribl Stream, you must update a DCR Template with Stream definitions. We've provided an example [DCR Template](usecase-webhook-azure-sentinel-dcr-template) file.
