...
```js
Lookup: (file: string, primaryKey?: string, otherFields: string[]=[],ignoreCase: boolean = false) => InlineLookup
```
...
```js
LookupCIDR: (file: string, primaryKey?: string, otherFields: string[]=[]) => InlineLookup
```
...
```js
LookupIgnoreCase: (file: string, primaryKey?: string, otherFields: string[]=[]) => InlineLookup
```
...
```js
LookupRegex: (file: string, primaryKey?: string, otherFields: string[]=[]) => InlineLookup
```
