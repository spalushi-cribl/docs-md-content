...
To understand precisely what one of these files does, select it to open its **AppScope Configs** modal and click **Manage as JSON**. For explanations and definitions, see the [Config File](https://appscope.dev/docs/config-file) and [Schema Reference](https://appscope.dev/docs/schema-reference) sections in the AppScope docs.
