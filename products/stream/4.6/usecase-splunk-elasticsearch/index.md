...
![Splunk Source configuration](splunk-tcp-source.00d6563b65.png)
{border="true"}
...
![Elasticsearch Destination configuration](elasticsearch-destination.228a68c8ee.png)
{border="true"}
...
![Eval Function](eval-function.afe0971456.png)
{border="true"}
