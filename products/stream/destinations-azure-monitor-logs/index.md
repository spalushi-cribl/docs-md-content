...
>The Azure Monitor Log Destination is now deprecated. The replacement for routing data to the Microsoft Log Analytics platform is the [Microsoft Sentinel Destination](destinations-sentinel). This change aligns with the Microsoft recommendation to use the [Azure Monitor Logs Ingestion API](https://learn.microsoft.com/en-us/azure/azure-monitor/logs/logs-ingestion-api-overview), which the Microsoft Sentinel Destination is built upon.
>
...
## Configure Cribl Stream to Output to Azure Monitor Logs
...
Azure Monitor Logs does not require any specific permissions.
