...
Cribl Stream will offer you further time savings as you configure the internal data transformation. Cribl Stream's [Pipeline Data Preview](data-preview) features enable you to test transformations' results as you build your Pipeline, before you commit or run it.
...
![Splunk Source configuration](splunk-tcp-source-4101.png)
{border="true"}
...
![Elasticsearch Destination configuration](elasticsearch-destination-4101.png)
{border="true"}
...
![Regex Extract Function](regex-extract.643c776b78.png)
{border="true"}
...
![](lookup-function.cdd053f815.png)
{border="true"}
...
![GeoIP specialized lookup](geoip-function.e481d23f4f.png)
{border="true"}
...
![Eval Function](eval-function-4101.png)
{border="true"}
