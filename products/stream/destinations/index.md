...
![Diagram illustrating data flowing from Sources into Cribl Stream and then on to Destinations](sources-destinations-june-2025.png)
{caption="Flow of data from Sources into Cribl Stream and then on to Destinations." border="false"}
...
| [Cloudflare R2](destinations-cloudflare-r2) | HTTP/S | Non-Streaming | ✓
| [Cortex XSIAM](destinations-xsiam) | HTTP/S | Streaming
...
| [Databricks](destinations-databricks) || Non-Streaming | ✓
...
| [Fabric Real-Time Intelligence](destinations-fabric-real-time-intelligence) | TCP | Streaming
| [Filesystem/NFS](destinations-fs) || Non-Streaming | ✓
| [Google Cloud Chronicle API](destinations-google-chronicle-api) | HTTPS only | Streaming
...
| [SentinelOne AI SIEM](destinations-sentinel-one-ai-siem) | HTTP/S | Streaming
...
> to send data to downstream services like Snowflake,
