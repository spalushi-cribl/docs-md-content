...
For S3 Collector operation, ensure outbound TCP [port](ports#integrations-and-apps) `443` is open from all Worker Nodes to the relevant S3 endpoints. This is required for connectivity in Cribl.Cloud, hybrid, and on-prem deployments.

Avoid SSL inspection or filtering on S3 Collector traffic, as this can disrupt secure connectivity and data collection.
