...
| CRIBL-33777 | Fixed an issue that prevented Packs from importing configurations with load-balanced Sources or Destinations when running a Single-instance deployment for Cribl Stream. |
