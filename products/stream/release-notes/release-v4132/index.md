...
Cribl Stream v4.13.2 corrects three [critical issues](https://docs.cribl.io/results/?query=CRIBL-34737&searchOption=known-issues) found in Cribl Stream v4.13.1 and rolls back the AWS SDK to v2 for on-premises and hybrid deployments:

## Important Changes

For all on-premises and hybrid deployments, we have reverted the AWS SDK to v2. This change addresses the following [issues](https://docs.cribl.io/results/?query=&searchOption=known-issues&product=stream&reported-from=4.13.1) with AWS integrations that occurred following the upgrade to v3 in the 4.13.1 release.
