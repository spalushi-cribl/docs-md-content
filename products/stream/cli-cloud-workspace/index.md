...
Updates an on-prem Leader Node with a new config in the `instance.yml` file called `cloudWorkspace`.
With this config, the local Leader will [connect to the Cribl.Cloud Leader](cloud-connected-env) and send it usage metrics.
