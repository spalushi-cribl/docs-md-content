...
Cribl Stream supports receiving data records from a [Kafka](https://kafka.apache.org/) cluster. This Source automatically detects compressed data in `Gzip`, `Snappy`, `LZ4`, or `ZSTD` format, and automatically decompresses the data upon ingesting it.
