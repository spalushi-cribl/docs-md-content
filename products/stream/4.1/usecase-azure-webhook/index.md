...
From a Cribl Stream instance's or Group's **Manage** submenu, select **Data** > **Destinations**, then select **Webhook** from the **Manage Destinations** page's tiles or left nav. Click **Add Destination** to open the **Webhook** > **New Destination** modal.
