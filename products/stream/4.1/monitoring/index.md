...
![Monitoring > Data submenu (Pipelines selected)](monitoring-data-submenu.2c8524545d.png)
...
The **Data** > **Data Fields** page lets you preview the flow of events that contain a specific data field.
...
located at **Settings** > (**Global Settings**) > **System** > **General Settings** > **Limits** > **Metrics** > **Disable field metrics**.
...
- The left (blue) side summarizes events in/out. The right (amber) side summarizes bytes in/out.
...
![Routes page's multiple rows and controls](routes-dashboard.e2f0329d5e.png)
{border="true"}
...
![Monitoring > System submenu (Jobs in‑flight selected)](monitoring-system-submenu.ed1506034e.png)
...
![Monitoring Leader Nodes](se-monitoring-leaders.62fd952b0c.png)
{border="true"}
...
![Monitoring > Licensing](st-monitoring-license.a3918eed8a.png)
{border="true"}
...
![Manage Logging Levels page](log-levels-composite.42757ed376.png)
{border="true"}
