...
> If you are creating a Trust Relationship for a Cribl-managed [Cribl Cloud](deploy-cloud) Worker, skp this section. Cribl has implicitly preconfigured Account A for you.
>
{.box .success}
...
![Cribl Stream Assume Role configuration](aws-collector-config~assume-role.d3b5566d4c.png)
{border="true"}
