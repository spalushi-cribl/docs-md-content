...
Amazon Security Lake ingests events described by the [Open Cybersecurity Schema Framework](https://schema.ocsf.io/categories) (OCSF) and conveyed as Parquet files. This Destination sends the Parquet files in batches. Cribl Stream does not read or replay the data sent to Amazon Security Lake.
...
> 1. In Cribl Stream, create an Amazon Security Lake Destination.
> 1. In Cribl Stream, create a Source and connect it to the Amazon Security Lake Destination.
