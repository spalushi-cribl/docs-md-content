...
> As of v.4.1.2, the [Prometheus Scraper](sources-prometheus) Source is deprecated on Cribl Edge. Cribl plans to remove it from Cribl Edge by v.4.2. Please use this Source instead. 
>
{.box .warning}
