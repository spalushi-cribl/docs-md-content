...
![Event, Table, and Advanced options (composite screenshot)](preview-INJSON-3.1.3.3d781902cd.png)
{border="true"}
...
The **Pipeline Profile** tab, available from the **Simple Preview** tab, helps you debug your Pipeline by showing individual Functions' contributions to data volume, events count, and the Pipeline's processing time.
...
![Collapse / Expand toggle (composite)](preview-toggle-composite-3.0.7ef485e537.png)
