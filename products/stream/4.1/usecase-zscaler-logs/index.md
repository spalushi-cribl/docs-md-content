...
![Parsing with a Code Function](st-zscaler-03.33b53461e4.png)

An [Eval Function](eval-function) reshapes the data:

![Reshaping with Eval](st-zscaler-04.8d4e54cc0b.png)

And finally, a [Serialize Function](serialize-function) drops unwanted fields:

![Dropping fields with Serialize](st-zscaler-05.a85680590f.png)
