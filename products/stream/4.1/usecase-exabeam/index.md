...
![Saving captured data](st-usecase-exabeam-step1b.897f82e422.png)
{border="true"}
...
![Reformatting the event](st-usecase-exabeam-step2.26bd6c969a.png)
{border="true"}
...
![Extraneous newlines/returns to remove](st-usecase-exabeam-step3.803b05401c.png)
{border="true"}
...
![Eval Function to add an Exabeam-specific field](st-usecase-exabeam-step4.90416c6b56.png)
{border="true"}
...
2. Click **Add Destination** to configure and save a new [Syslog Destination](destinations-syslog) to export data to Exabeam.  

   Configure the **Address**, **Port**, **Message format**, **Timestamp format**, and other options to match your Exabeam implementation.

![Configure Syslog](st-usecase-exabeam-step9a.167edb6b0d.png)
{border="true"}
