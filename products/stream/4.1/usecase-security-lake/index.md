...
![Integrating Cribl Stream with Amazon Security Lake](security-lake-integ-01.492a97ba6a.png)
{border="true"}
...
## Setting Up Cribl Stream {#set-up-stream}
...
1. Click **Manage Stream** or **Manage Edge** to open the **Worker Groups** page.
1. Click the name of the Worker Group whose Worker Nodes you want to send data to Amazon Security Lake. (For this example, we'll use the `default` Worker Group.) This takes you to the **Manage** > **Overview** page.
