...
![Collector configuration for basic HTTP GET](rest-ex-1b.86fc68410d.png)
...
![Collector configuration for HTTP GET, paginated via URL Attribute](rest-ex-2b.08827543a8.png)
{border="true"}
...
![Collector configuration for HTTP GET, paginated via Response Body Attribute](rest-ex-3a.d00864fdb8.png)
{border="true"}
...
![Collector configuration for HTTP GET, paginated via Response Header URL](rest-ex-4a.12234c5a7f.png)
{border="true"}
...
![Collector configuration for HTTP Discover and Collect with Login authentication](rest-ex-5b.ea50dbc1b1.png)
{border="true"}
...
![Collector configuration for Discovery via Item List](rest-ex-6a.796726989e.png)
{border="true"}

![Fields (Metadata) configuration](rest-ex-6b.211a4eda5c.png)
{border="true"}
...
![Collector configuration for JSON Response Discovery](rest-ex-7a.3e612cd02c.png)
{border="true"}
