...
2. In the **New Source** modal, configure the following under **General Settings**:
     ...
     - **Bootstrap servers**: List of Kafka bootstrap servers to use, for example, `localhost:9092`.
...
[Snippet not found: content/shared/4.10/snippets/_common-errors-kafka.md]
