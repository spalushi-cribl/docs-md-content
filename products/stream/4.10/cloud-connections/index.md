...
Connecting your on-prem Cribl Stream to Cribl.Cloud simplifies licensing and billing. Universal Subscription lets you manage all on-prem environment costs from a single Cribl.Cloud interface, eliminating the need for separate on-prem licenses. This streamlines administration and provides a unified view of your Cribl Stream usage and spending. For details, see [Connect On-Prem Leaders to Cribl.Cloud](cloud-connected-env).
...
- The on-prem Leader in your Distributed deployment must be running Cribl Stream 4.8.2 or newer.
