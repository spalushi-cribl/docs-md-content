...
[**Max number of connections**](settings-group-fleet#redis-connections-limit) is the upper limit of connections to Redis that Cribl Stream can establish before starting to reuse them.
