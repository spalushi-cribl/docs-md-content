...
>
>For guidance on when to choose this Source versus the [Cribl HTTP](sources-cribl-http) Source, see [Interoperation Protocols](/suite/reference-arch-full-suite/#protocols).
{.box .info}
