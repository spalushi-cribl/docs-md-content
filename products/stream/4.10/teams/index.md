...
1. If you have SSO configured in your Organization, in **Mapping IDs**, you can provide a list of external IDs for the Team.
   Use them when integrating with SSO to map Workspace roles with [IDP groups](sso-initial-steps#linking-idp-groups-with-teams).
