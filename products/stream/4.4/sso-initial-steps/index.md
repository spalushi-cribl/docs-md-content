...
In your IDP, configure user groups that match Cribl.Cloud [Role/Permissions](cloud-managing#member-roles). Using Okta as an example, you'd map Okta groups (right side) to Cribl.Cloud Roles (left side) as follows. 
...
> See the [Microsoft Entra ID + OpenID Configuration](/stream/usecase-azure-ad#configure-token-and-claims) topic.
>
{.box .warning}
