...
> On Cribl-managed [Cribl.Cloud](deploy-cloud) Worker Nodes (with an [Enterprise plan](cloud-enterprise)), this tab should expose only the destructive **Clear Persistent Queue** button (described below in this section).
> 
