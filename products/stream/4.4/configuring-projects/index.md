...
For [Cribl.Cloud](deploy-cloud) Leaders, and Worker Groups of Cribl-managed Cribl.Cloud Workers, Projects' metrics are always available to the CriblMetrics Source. This availability is not configurable.
