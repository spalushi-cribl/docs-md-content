...
1. Optionally, in **Advanced Settings**, configure the **Metadata** values **SITENAME** and **TIMEZONE**. Keep the values you entered handy – you'll need them when configuring the Cribl Stream Exabeam Destination.
    > Cribl Stream version 4.4.4 copies the value of **SITENAME** into another **Metadata** field named **SITE ID**. Therefore, when **SITENAME** is set, both metadata fields will have values. Cribl recommends that you do not leave **SITENAME** blank.
    >
    {.box .info}
2. Click **Install**.
