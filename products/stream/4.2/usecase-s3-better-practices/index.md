...
![Cribl.Cloud ARN](st-usecase-best-practices-ss4.20112f95de.png)
{border="true"}
...
![Configuring S3 Destination Settings](st-usecase-best-practices-ss5.694e861e83.png)
{border="true"}

![Configuring S3 Destination Settings- Continued](st-usecase-best-practices-ss6.7b6dc95a9d.png)
{border="true"}
...
![Set File Compression](st-usecase-best-practices-ss7.00f5d4fbf6.png)
{border="true"}
...
![VPC Endpoint URL in the Cribl S3 Destination](st-usecase-best-practices-ss9.e730d3fc9d.png)
{border="true"}
...
![S3 Destination Notifications](st-usecase-best-practices-ss14.b9b7c48bed.png)
{border="true"}
