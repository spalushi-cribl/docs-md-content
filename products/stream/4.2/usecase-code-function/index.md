...
![Log messages from a Code Function](code-fn-7-log-error.1b7a67e601.png)

### Debugging

The Code Function’s execution context defines a helper function called `debug` that can be used for debugging purposes.

![Debugging a Code Function](code-fn-8-debug.1bb80db677.png)

Messages logged by this `debug` helper function are shown in the Preview Log by default. 

![Debugging a Code Function with the Preview Log](code-fn-9-log-msg.9073d9ef69.png)
...
![Debugging a Code Function with regular logs](code-fn-10-log-level.58584e481c.png)

### Previewing

By using the expanded editor, users can run the expression against a sample event, and can preview the transformation:

![Previewing a Code Function's transformation of an event](code-fn-11-expression-editor.17d9f98c71.png)
...
![The global `C.*` object of a Code Function](code-fn-13-internal-methods.5790cec8e0.png)
