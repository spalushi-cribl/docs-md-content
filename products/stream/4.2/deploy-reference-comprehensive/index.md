...
> 
> This architecture shows customer-managed (on-prem) Worker Groups and primary/standby Leaders. For a Cloud-centric alternative, see [Comprehensive Hybrid Cloud Reference Architecture](deploy-reference-comprehensive-hybrid).
>
{.box .success}
