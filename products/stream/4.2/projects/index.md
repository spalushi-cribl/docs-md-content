...
Enabling Projects requires either an Enterprise [license](licensing) and a distributed on-prem deployment, or a Cribl.Cloud Enterprise [plan](deploy-cloud#enterprise).
