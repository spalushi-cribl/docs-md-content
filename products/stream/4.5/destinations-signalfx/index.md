...
For details on integrating with SignalFx, see the [SignalFx Developers Guide](https://developers.signalfx.com/). Especially relevant is the [SignalFx HTTP Send Metrics Reference](https://developers.signalfx.com/ingest_data_reference.html#tag/Send-Metrics).
