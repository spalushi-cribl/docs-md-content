...
![Registering an Azure AD app](azure-ad-register-app.592bda4cad.png)
{border="true"}

###  Get the Azure AD App's Basic Credentials  {#credentials}
...
![Editing the groups claim](azure-id-groups-claim-2.a5a415fad3.png)
{border="true"}

3. Your token is now configured, and you're all done on the Azure side.

![Azure AD token configuration complete](azure-ad-token-complete.0801d509bc.png)
{border="true"}
...
- **Client ID**: Enter your Azure AD **Application (client) ID**. (In the Azure portal, see [above](#credentials) to copy this from your app's **Overview** page.)
...
- Optionally, enable **Allow login as Local User** as a fallback login method.
...
###  Map Azure AD Groups to Cribl Stream Roles  {#map}

Next, map your Azure AD groups to Cribl Stream [Roles](roles). The group names might appear as GUIDs. You can translate these on the Azure AD **Groups** page.
...
![Azure AD groups...](azure-ad-groups.40528e6f5e.png)
{border="true"}
