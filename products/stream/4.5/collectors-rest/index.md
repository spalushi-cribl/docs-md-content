...
Alternatively, you can create a REST Collector by importing its configuration and entering desired values for any placeholders as described [here](collectors#importing-json).
