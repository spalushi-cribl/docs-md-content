...
- [SAML/Azure AD Setup Examples](saml-azure-setup)
- [Final SSO Steps & Troubleshooting](sso-final-steps)

SSO integration requires you to perform certain configuration steps in your identity provider (IDP), and to then submit corresponding information to Cribl. As of Cribl Stream 4.0, you can submit these details directly on your Cribl.Cloud portal's [Organization](cloud-portal#organization) page.

![Organization page SSO tab](cloud-sso-tab.650fa26dd8.png)
{border="true"}
