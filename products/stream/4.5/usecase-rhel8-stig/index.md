...
To run an upgrade on the Leader Node when using fapolicy, follow the below steps. See our [upgrading docs](upgrading#upgrade-the-leader-node) for more details.
