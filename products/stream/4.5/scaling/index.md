...
To provision a container with a set amount of Worker Processes, use the
`CRIBL_MAX_WORKERS` environment variable. Setting a maximum amount of Worker
Processes helps prevent overloading the node with more CPUs than it can handle.
