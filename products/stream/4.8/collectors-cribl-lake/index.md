...
Cribl Lake Collector can gather data from both [Cribl-Managed](cloud-workers) ("Cloud")
and [Hybrid](worker-groups) Stream Worker Groups.
...
6. Configure the following under **General Settings**:
...
8. Optionally, configure any [Result](#result-settings) and [Advanced](#advanced-settings) settings outlined in the below sections.

9. Click **Save**, then **Commit & Deploy**.

10. Verify that data is being collected. See the [Verify Data Flow](#verify) section below.
