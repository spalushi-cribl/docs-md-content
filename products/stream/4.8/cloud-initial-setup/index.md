...
1. Follow the on-screen instructions to provide your name and additional (optional) personal information, agree to the Subscription Services Agreement, and then use the welcome email you receive from Cribl to verify your account.
1. On the **Create your Organization** page, enter an **Organization name** (a friendly alias for the randomly generated ID that Cribl will assign to your Organization), and then select an AWS Region to host your Cribl.Cloud Leader and AWS-based Cribl-managed Workers. Cribl currently supports the following Regions:
   - `US West (Oregon)`
   - `US East (Virginia)`
   - `US East (Ohio)`
   - `Europe (Frankfurt)`
...
1. Complete the quick survey to let us know how you plan to use Cribl. The goals you select and the Sources and Destinations you choose will be used to offer you personalized guidance as soon as you open your Workspace. 
