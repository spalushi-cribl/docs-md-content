...
- All Cribl.Cloud deployments, at the Organization level. (A Cribl.Cloud Enterprise [plan](cloud-enterprise) also offers granular access control on products, Worker Groups, and lower-level resources.)
...
1. Select **Settings** > **Global Settings** > **Members and Teams**.
...
3. From the top-left product switcher, select **Cribl Stream**. Then select **Settings** > **Cribl Stream Settings** > **Members and Teams**.
...
> The 4.1.x `project_user` Role and `ProjectSourceSubscribe` Policy, which provided access to all Projects, are retired in Cribl Stream 4.2.x and later.
