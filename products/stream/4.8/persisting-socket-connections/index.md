...
Many Linux distributions maintain a system cleaner service (such as [systemd-tmpfiles](https://man.archlinux.org/man/systemd-tmpfiles-clean.service.8)) that removes files from the temp directory periodically, such as every 10 days. If Cribl's sockets are removed, certain product pages (such as [Monitoring](monitoring)) break. 
...
1. Restart the Cribl server via the [UI](configuration-files#restart) or [command line](cli-reference#restart).
...
Specify the directory in **Settings** at **Global Settings** > **System** > **Distributed Settings** > **Leader Settings** > **Helper processes socket dir**.