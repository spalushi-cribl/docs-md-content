...
If you have an on-prem Cribl Stream environment and an Enterprise Cribl.Cloud account, you can use the **Connected Environments** 
...
> An on-prem Cribl Stream environment consists of at least one Leader Node (the control plane) and one or more Worker Groups.
{.box .info}

Connecting your on-prem Leader to Cribl.Cloud allows you to:

- Monitor credit consumption for each of your on-prem Cribl Stream environments
  from one user interface.
- Create a connection between the Cribl Stream on-prem Leader and the Cribl.Cloud
...
- The Universal Subscription feature is available only for Enterprise Cribl.Cloud accounts.
- Single-instance deployments of Cribl Stream aren't eligible for a Universal Subscription.
...
To connect existing on-prem deployments of Cribl Stream to Cribl.Cloud, you must be
...
1. If you're using the Environment variable, copy the environment variable
   ...
   <br>For example, if your Cribl Stream deployment is running in a container, set
...
1. Log in to your Cribl Stream account as an Admin.
...
Cloud deployments of Cribl Stream. You must be an Organization Owner to view this data.
...
1. Select the product drop-down to choose a **Connected Deployment** of Cribl Stream.
