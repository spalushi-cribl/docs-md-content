...
From Cribl Stream's top nav, select **Monitoring** to access the Monitoring section of Cribl Stream. The Monitoring section has these submenus:
...
| [System](#system-submenu) | View isolated throughput data for: <ul><li><a href="#job-inspector">Job Inspector</a></li><li>Jobs (and tasks in-flights; see <a href="../collectors">Collector Sources</a>)</li><li>Leaders (available only with High Availability enabled; see <a href="../deploy-add-second-leader">Second Leader</a>)</li><li><a href=#licensing>Licensing</a></li><li><a href="../persistent-queues">Queues</a> (Destinations)</li><li><a href="../persistent-queues">Queues</a> (Sources)</li></ul> |
