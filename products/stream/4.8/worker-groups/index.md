...
1. In the resulting **Groups** screen, select **Add Group**.
...
1. On the **Groups** page, in the **Actions** column, select ••• (Options).
1. Select **Clone**.
...
1. Select the top nav's **Manage** tab, select **Groups**, then select **Add Group**.
