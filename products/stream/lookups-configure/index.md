...
You can update lookup files using the API if needed. Use the API if your lookup files need frequent updates or as part of an automated process. See [Create and Update Lookups](/cribl-as-code/create-update-lookups/) in the API documentation for more information.
