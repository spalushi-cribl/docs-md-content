...
Global Variables are reusable JavaScript expressions that can be accessed in [Functions](functions) in any [Pipeline](pipelines). You can access the library from Cribl Stream's top nav under **Processing** > **Knowledge** > **Global Variables**.
