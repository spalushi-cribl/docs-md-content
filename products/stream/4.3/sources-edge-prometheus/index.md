...
Cribl Stream will write metrics to the default location: `CRIBL_HOME/state/spool/in/edge_prometheus/${inputId}`. Use the [environment variable](environment-variables#internal) `CRIBL_SPOOL_DIR`, to change the default path. 
