...
- The **Daily Events In** chart only shows events that count towards your license. It filters out `datagen`, `cribl_http`, and `cribl_tcp` events.

![Monitoring > Licensing](st-monitoring-license.5baf789243.png)
{border="true"}
