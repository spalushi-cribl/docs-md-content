...
> 
> If you'd prefer a similar tutorial based on Cribl Stream's simplified, visual QuickConnect UI, see our [CrowdStream](deploy-crowdstream#routing) setup guide. All the steps shown there work in Cribl.Cloud as well.
> 
...
![Monitoring dashboard](monitoring-page.5c43cd28c2.png)
{border="true"}
...
![Monitoring Sources](monitoring-sources.08183d1c89.png)
{border="true"}
...
![Monitoring Destinations](monitoring-destinations.8393420433.png)
{border="true"}
