...
- [Parquet schemas](parquet-schemas) for writing data from a Cribl Stream Destination to Parquet files.
...
To access the schema library, select **Worker Groups** from the sidebar, and choose a Worker Group.
Then, on the **Worker Groups** submenu, select **Processing**, then **Knowledge**, then **Schemas**.
