...
> If you're new to Cribl Stream, please see our [Basic Concepts](basic-concepts) page and [Getting Started Guide](getting-started-guide) for orientation. This Cribl.Cloud documentation focuses on a Cloud deployment's differences from other deployment options – referred to as "customer-managed deployments."
> 
