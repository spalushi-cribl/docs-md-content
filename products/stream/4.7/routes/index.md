...
![Routes and bytes](routes-443.png)
{border="true"}
...
![Route > Options menu](routes-context-menu.8e860e2678.png)
{border="true"}
...
![Comments make the Routing table self-documenting](routes-insert-comment.f0c497ad8a.png)
{border="true"}
