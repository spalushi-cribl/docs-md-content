...
1. In the Source modal, configure the following under **General Settings**:
   ...
   * For **Client Certificate**:
     ...
     * **Verify certificate via OCSP**: If toggled to `Yes`, Cribl Stream will use an OCSP (Online Certificate Status Protocol) service to check that client certificates presented in incoming requests have not been revoked. Exposes the **Strict validation** toggle.
