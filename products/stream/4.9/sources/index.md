...
To capture data from a single enabled Source, you can bypass the [Preview](data-preview) pane, and instead capture directly from the list of Sources. Just select the Source type, and then select the **Live** button beside the Source you want to capture.
