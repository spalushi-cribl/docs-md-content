...
| `443` | HTTP/S | (In Cribl.Cloud hybrid deployments) Communication with the Leader for bootstrapping, and with `https://cdn.cribl.io` to download configurations from CDN. | Out |
