...
![Event Breaker configuration](rest-ex-2a-4.9.png)
...
![Event Breaker configuration](rest-ex-3-0-breaker-config-4.9.png)
{scale="30%" border="true"}
...
![Event Breaker configuration](rest-ex-5a-4.9.png)
{scale="40%" border="true"}

![Collector configuration for HTTP Discover and Collect with Login authentication](rest-ex-5b-4.9.png)
{border="true"}
...
![Fields configuration](rest-ex-6b-4.9.png)
{border="true"}
...
![Collector Config - Event Breakers](usecase-rest-state-tracking-conf2-4.9.png)
{border="true"}
