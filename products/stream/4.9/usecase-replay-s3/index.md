...
> Cribl Stream supports replaying data that has been exported as Parquet, through any of the following: [Amazon S3](/stream/collectors-s3/) Collector, [Azure Blob Storage](/stream/collectors-azure-blob/) Collector, [Google Cloud Storage](/stream/collectors-google-cloud-storage/) Collector, or [Filesystem](/stream/collectors-filesystem/) Collector.
>
{.box .success}
...
![Pipeline configuration](99RIXMD.daabf75aae.png)
{scale="70%"}
...
![Cribl Event Breaker Ruleset](4cwz2nM.405d7fc097.png)
...
![__replayed field](LYXJYUP.14efc44ad2.png)
