...
- If a single syslog sender is sending more than 100 GB/day over TCP, enable [TCP load balancing](/stream/sources-syslog#tcp-lb) on the Cribl Stream Source. Also, size an additional CPU to host a Worker Process dedicated to load balancing.
