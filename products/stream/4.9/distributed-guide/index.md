...
![Source (Datagen) configuration](datagen-weblog-config-4.9.png)
{border="true"}
...
![Adding Eval Function to Pipeline](add-eval-fn-4.9.png)
{border="true"}
...
![Route attached to Pipeline and Destination](route-splunk-connected-4.9.png)
{border="true"}
...
![CriblMetrics Source enabled](source-cribl-internal-metrics-4.9.png)
{border="true"}
...
![Cribl metrics Route, Pipeline, and Destination wired up](metrics-route-4.9.png)
{border="true"}
