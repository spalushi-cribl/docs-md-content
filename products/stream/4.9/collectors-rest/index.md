...
**Fields**: You can add Fields to each event, using [Eval](eval-function)-like functionality. Selecting the **Add Field** button exposes these additional fields:
...
1. Set the **Format discover result with custom code** option to `Yes`.
