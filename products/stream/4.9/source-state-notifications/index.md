...
In Cribl Stream, you can configure Notifications on Sources and Collectors to trigger under these conditions:
...
## Configure Source Notifications  {#configuring-s}
...
1. Access this Source's **Notifications** tab by one of the following methods: 
    - Select the **Notifications** button on the Source page's appropriate row.
    - Reopen the Source's configuration modal and select its **Notifications** tab.
2. Select **Add Notification** to access the **New Notification** modal shown here.

![Configuring a Source Notification](notification-source-tab.png)
{border="true"}

### View Count of Configured Source Notifications

In the **List** view of a Source, you can quickly see how many
Notifications are configured. The **Notifications** button will display a badge
showing you the number of configured Notifications for the Source.
