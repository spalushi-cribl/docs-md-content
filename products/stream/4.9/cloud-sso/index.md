...
With a Cribl.Cloud account on [certain plan/license tiers](https://cribl.io/pricing/), you can set up a Single Sign-On (SSO) integration between your identity provider (IDP) and your Cribl.Cloud portal.

The general steps to set up a Single Sign-On (SSO) integration between your IDP and your Cribl.Cloud portal are:
...
3. Submit your app's configuration details to Cribl on your Cribl.Cloud portal's **Organization** > **SSO Management** page. (This will complete your SSO setup on the Cribl side.)
