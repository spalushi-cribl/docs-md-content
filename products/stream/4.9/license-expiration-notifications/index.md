...
##  Configure License-Expiration Notifications  {#configuring-license}

1. In the sidebar, select **Settings** > (**Global** >) **Licensing**. 
2. Select **Add Expiration Notification** to access the **License Notifications** modal.
