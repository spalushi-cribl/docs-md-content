...
![Manage Syslog Sources UI](crowdstream-sources-list-4.9.png)
{border="true" scale="90%"}
...
![Changing a Route's Destination (Output)](crowdstream-default-route-4.9.png)
{border="true"}
...
![Tuning a Route's Filter expression](crowdstream-route-filter-4.9.png)
{border="true"}
