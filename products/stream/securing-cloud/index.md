...
Cribl.Cloud is SOC 2 Type II–certified and GDPR-compliant, simplifying compliance with industry standards and regulatory requirements. For Cribl.Cloud security architecture details, see [Cribl.Cloud Security Practices](/reference-architectures/arch-cloud-security-practices/).
...
Cribl.Cloud offers detailed role-based access control (RBAC) to ensure appropriate permissions and security. For details on how to invite and manage the roles for Members of your Organization, see [Members](members#invite-members).

## Set Up Your Preferred Authentication Method

When your Cribl.Cloud Organization uses a [certain plan](https://cribl.io/pricing/),
you have a range of secure and convenient login options to fit your Organization's needs,
including:
...
Cribl.Cloud provides built-in encryption for data at rest, ensuring that your information remains secure within its infrastructure. 
...
Currently, Cribl Stream supports decryption only when Splunk is the end system. For details, see [Decryption of Data in Splunk](/stream/securing-data-decryption).
...
A Cribl.Cloud Organization on a [certain plan](https://cribl.io/pricing/) offers a Key Management Service (KMS) that strengthens the security of your data. KMS securely manages the encryption keys used to protect sensitive information on Worker Groups and Nodes within Cribl.
