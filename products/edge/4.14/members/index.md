...
However, [Cribl.Cloud invitations](#invite-memebers) and [Stream Projects](/stream/sharing-projects) have fully transitioned to the new model. For detailed differences between the two access control systems, see [Which Access Method Should I Use?](access-management#restrictions).
...
![Invite Member modal](cloud-invite-4.13.png)
...
7. Under **Permissions**, assign an appropriate [Organization-level Permission](permissions#organization) for the Member.
8. If you selected the **User** role, under **Workspace Access**, define access to specific [Workspaces](workspaces).

   > Assigning the **User** role requires an Enterprise plan. For details, see [Pricing](https://cribl.io/pricing/).
   {.box .info}
