...
[**Connection limit**](group-settings#redis-connections-limit) is the upper limit of connections to Redis that Cribl Edge can establish before starting to reuse them.
