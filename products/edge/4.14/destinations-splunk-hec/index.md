...
Cribl Edge uses the internal field `__criblMetrics` to determine whether to process an event as a metric or a log. See [Splunk's documentation](https://docs.splunk.com/Documentation/Splunk/latest/Data/FormateventsforHTTPEventCollector#Event_data) on their event format for HEC events.
