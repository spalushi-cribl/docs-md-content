...
1. Navigate to the directory where Cribl Edge is installed:
...
| [mode-outpost](/edge/cli-mode-outpost) | Command to configure an instance as a Cribl Outpost |
...
| [pq](cli-pq) | Command for persistent queue performance benchmarking |
