...
1. On the top bar, select **Products**, and then select **Edge**.
1. In the sidebar, select **Outposts**.

You will see a list of all Outposts, including disconnected ones.
Select any row in the table to see a drawer with detailed information about the Outpost.
...
To view Outpost logs, consult the **Logs** tab in the Outpost drawer.
For more information about Outpost logs, see [Internal Logs](internal-logs#outpost).

### Create Outpost Diagnostic Bundle

In the outpost drawer you also create a diagnostic bundle to help to share with Cribl Support as help in diagnosing any issues.
...
1. Upgrade Outposts.
1. Upgrade individual Edge Nodes.
