...
| "ERROR_UNMATCH_CERTIFICATE_DECLARATION_IN_METADATA" | **X.509 Certificate**: verify that the certificate is correct and [update the certificate](sso-cloud#update-cert-saml-cloud) if needed. |
