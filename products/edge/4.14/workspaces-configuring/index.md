...
Learn how to configure Workspaces in your Cribl.Cloud deployment.

-----------------------------------------------------------------

## Before You Begin
When you create a new Workspace in Cribl.Cloud, Cribl automatically provisions
Cribl-managed Worker Nodes in the `default` Worker Group. **These Worker Nodes
consume infrastructure credits**, but you can deprovision the `default` Worker Group from
Worker Group settings. See [Manage Cribl.Cloud Worker
Groups](/stream/cloud-workers#cloud-costs) for steps.

## Add New Workspace

To create a new Workspace:

1. On the top bar, select your current Workspace name. This opens a modal with a
