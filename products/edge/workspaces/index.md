...
> Multiple Workspaces require a Cribl.Cloud Enterprise plan. For details, see [Pricing](https://cribl.io/pricing/).
{.box .cloud}
...
> Configuring Stream Groups (beyond the `default` Group) requires a certain plan. For details, see [Pricing](https://cribl.io/pricing/).
...
During this time, rule editing is temporarily disabled to prevent conflicts. 
