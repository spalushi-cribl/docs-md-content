...
The Cribl HTTP Destination is available only in [distributed deployments](/stream/deploy-distributed). It enables Edge Nodes to send data to peer Nodes, as long as all Nodes are connected to the same Leader.
