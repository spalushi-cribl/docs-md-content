...
**Fields to serialize**: Required for `CSV`, `ELFF`, `CLF`, and `Delimited values` Types. (All other formats support [wildcard field lists](introduction-reference#wildcard-lists).)
