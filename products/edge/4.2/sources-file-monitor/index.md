...
>
> The 4.2.0/4.2.1 File Monitor Source, when run in Manual Discovery mode, causes a memory leak that eventually causes Edge Nodes to crash. For details, fix timeline, and workaround, please see [Known Issues](known-issues#CRIBL-19154).
>
{.box .warning}
