...
> As of version 3.0, Cribl Edge's former "master" application components are renamed "leader." As long as some legacy terminology remains within CLI commands/​options, configuration keys/values, and environment variables, this document will reflect that.
>
{.box .info}
...
create              - Creates diagnostic bundle for Cribl Stream/Edge, args:
  ...
  [-t <number> ]    - Latest number of jobs to include in bundle
...
heapsnapshot        - Creates a heap snapshot for Cribl Stream/Edge processes, args:
   -p <pid>         - Process ID
```
