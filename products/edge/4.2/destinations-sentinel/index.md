...
Cribl Edge can send log and metric events to the [Azure Sentinel SIEM](https://learn.microsoft.com/en-us/azure/sentinel/overview). (These docs use the terms "Azure Sentinel" and "Microsoft Sentinel" interchangeably.)
