...
Quickly set up a working instance of Cribl Edge.
...
Before you proceed, make sure that the hosts for all Cribl Edge agents – and for any Leader that you install on your own infrastructure – meet the [System Requirements](requirements) that we list for Linux and Windows.
...
> For details on Cribl.Cloud Organizations, refer to Cribl.Cloud documentation:
> 
> - [Register Cribl.Cloud Organization](cloud-initial-setup).
> - [Manage Cribl.Cloud organization](cloud-portal).
{.box .success} 
...
- Explore Cribl Edge on [Linux](explore-edge-linux) or [Windows](explore-edge-win) to learn more about the various capabilities of Cribl Edge by taking a tour through its UI.
