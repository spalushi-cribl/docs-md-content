...
To switch between two Edge Node views, select the List View ![](list-view-icon.png) icon or the Map View ![](map-view-icon.png) icon.

**List View**: This is a list of all the Nodes and their statuses in the
Fleet.
...
![View Edge Node](ed-hex-nodes4-9.png)
{border="true" scale="75%"}
