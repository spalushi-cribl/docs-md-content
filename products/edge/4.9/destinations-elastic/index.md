...
>
> For an example of using Cribl Edge to parse and enrich inbound events for Elasticsearch, see our [Splunk to Elasticsearch](/stream/usecase-splunk-elasticsearch/) topic.
> 
{.box .info}

## Configure Cribl Edge to Output to Elasticsearch
...
3. Under **Authentication**, toggle **Authentication enabled** to `Yes` to display **Authentication method** dropdown. Select one of these options:
