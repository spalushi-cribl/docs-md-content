...
> This Function was deprecated as of v.2.4, and has been removed from Cribl Edge as of v.4.0. Please instead use the [DNS Lookup](dns-lookup-function#reverse) Function's reverse lookup feature.
>
{.box .warning}
