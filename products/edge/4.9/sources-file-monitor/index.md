...
3. Next, you can configure the following **Optional Settings**: 
   ...
   - **Check file modification times**: If toggled to `Yes`, this Source will skip files with modification times older than the configured **Age duration limit**. 
   When you set an **Age duration limit** threshold, the Source will open every file and read through all its contents to seek a timestamp. For best performance, also enable the **Check file modification times** toggle to skip older files.
