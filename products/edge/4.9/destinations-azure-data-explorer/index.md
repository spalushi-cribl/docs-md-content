...
> On Cribl-managed [Cloud](deploy-cloud) Edge Nodes (with [certain plan/license tiers](https://cribl.io/pricing/)), this tab should expose only the destructive **Clear Persistent Queue** button (described below in this section).
> 
