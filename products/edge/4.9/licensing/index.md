...
1. Create a file named `license.yml`.
...
Once you have received a license that removes the telemetry requirement, you can disable telemetry in Cribl Edge' at **Settings** > **Global** > **System > General Settings > Upgrade & Share Settings > Share telemetry with Cribl**. Set the toggle to `No`.
