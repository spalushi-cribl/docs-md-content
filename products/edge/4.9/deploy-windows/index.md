...
1. If you select **Managed** mode, enter the Leader hostname or IP address,
   port, auth token, and optionally the Fleet and any tags.
...
1. Optionally **Create a desktop shortcut**.
...
1. Fill out the fields in the Add Windows Node window. The scripts update in real-time as you change the
   ...
   ![Add or update a Windows Edge Node](add-windows-node.png)
   {border="true" scale="75%"}
1. Copy and paste the resulting bootstrap script into Windows Command Prompt or Powershell.
