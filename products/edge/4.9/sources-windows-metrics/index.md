...
- Set to `No`: The Windows Metrics Source interacts directly with the Windows Management
    Instrumentation (WMI) API, resulting in faster metrics collection.

- Set to `Yes`: The Windows Metrics Source will collect events using `PS cmdlets`.
