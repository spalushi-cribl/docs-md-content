...
With Notifications, you can set up alerts that notify Cribl Edge admins about
...
Notifications are also sent as events to Cribl Edge
...
Cribl Edge stores these application-wide logs in `notifications.log` on the
...
Cribl Edge. For more information on license types and a feature comparison, see
our [Pricing page](https://cribl.io/pricing/). 

## Notifications and Targets

A Notification target allows you to specify where Cribl Edge delivers a
...
When an event occurs in Cribl Edge to trigger a Notification condition, you will 
...
Notifications work with Cribl Edge role-based access control. For users with
...
1. Select More and choose your Source or Destination.
...
License-expiration Notifications are only available for customer-managed instances of Cribl Edge. For
...
**ID**: Provide a unique ID for the Notification in this section. Cribl Edge
...
across Cribl Edge – for all Sources, Destinations, and license-based
