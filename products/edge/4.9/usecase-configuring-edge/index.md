...
Refer to [Create a Mapping Ruleset](https://docs.cribl.io/edge/mapping-edge-nodes/#creating-a-mapping-ruleset) for details on how to map Edge Nodes. 
...
For details, see [Host Info](https://docs.cribl.io/edge/explore-edge/#host-info).  
...
Aggregating individual log events into metrics reduces throughput volume, reducing your infrastructure requirements and optimizing your license utilization on downstream services.
