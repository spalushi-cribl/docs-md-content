...
> In Cribl.Cloud, the Filesystem Destination is only available on customer-managed [hybrid](cloud-enterprise#hybrid) Edge Nodes.
{.box .cloud}

## Configure Cribl Edge to Output to Filesystem Destinations
