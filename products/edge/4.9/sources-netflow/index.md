...
Cribl Edge supports receiving NetFlow v5 and v9 data via UDP.
...
## Configure Cribl Edge to Receive NetFlow Data
...
Cribl Edge collects and offers unregistered fields in an array of records consisting of their type codes and byte buffers. Cribl Edge can accept and handle additional Internet Protocol Flow Information Export (IPFIX) codes. However, Cribl Edge does not decode those values. You can add Pipeline functions to change how these fields are processed by default.
