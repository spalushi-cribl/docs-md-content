...
![Mask Function configuration for masking Social Security numbers](ssn-mask-config.2d5535ae00.png)
{border="true"}
...
![Mask Function configuration for masking credit card numbers](ccnumber-mask-config.8e3f1a2b4c.png)
{border="true"}
