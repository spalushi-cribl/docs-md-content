...
## Discover and Filter Kubernetes Events 
...
4. Optionally, configure any [Processing](#processing) and [Advanced](#advanced-tab) settings, or [Connected Destinations](#connected) outlined in the sections below.
