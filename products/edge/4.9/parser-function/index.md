...
**Type**: Parser/Formatter type to use. Options: 
  ...
  * **CSV** - selecting this type requires you to [escape](#escape) certain characters.
  * **Extended Log File Format**
  * **Common Log Format**
  * **Key=Value Pairs** – selecting this type requires you to [escape](#escape) certain characters.
  * **JSON Object**
  * **Delimited Values** – selecting this type [expands the UI](#expand-ui).
...
![Parser Function configuration for Example 4](parser-regex-example.9b2bab897f.png)
...
![Parser Function configuration for Example 5](parser-grok-example.830c8c8af1.png)
{scale="70%" border="true"}
