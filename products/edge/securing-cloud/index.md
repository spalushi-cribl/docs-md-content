...
Currently, Cribl Edge supports decryption only when Splunk is the end system. For details, see [Decryption of Data in Splunk](/stream/securing-data-decryption).
