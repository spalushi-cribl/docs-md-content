...
1. Check that events are flowing into Cribl Edge now according to the configured subscriptions. If they are not:
...
1. Copy the keytab file to the Cribl Edge Edge Node. Carefully note the file's location on the Edge Node, because you will need it later.
