...
>
> If you set **Max S2S version** to `v3`, Cribl recommends that you use the  `negotiateProtocolLevel = 0` setting shown above to avoid data loss. Depending on your environment, enabling `negotiateProtocolLevel` with a non-`0` value could cause Cribl Edge to not accept data from the forwarder.
> 
