...
### 2023-03-21 – v.4.1.0 – Unable to bind `CRIBL_DIST_LEADER_URL` to an IPv6 address [CRIBL-16284]
...
**Fix**: Planned for Cribl Edge 4.2.2.
...
### 2022-10-11 – All versions through 4.1 – GitOps Push mode doesn't support ad hoc Collection jobs [CRIBL‑12868]
...
### 2022-03-08 – versions 3.3.1 through Current – GitOps + License expiration = Catch-22 [CRIBL‑8600]
...
### 2022-03-07 – versions 3.2.x-3.4.x – Undercounted `total.in_bytes` dimension metrics [CRIBL‑8572]
...
### 2022-02-17 – versions 3.2.2-3.3.x – REST Collector pagination fails on duplicate/nested attribute names [CRIBL‑8352]
...
### 2022-02-10 – version 3.3.0-3.5.x – Slow-Mo Notification Notifications [CRIBL‑8205]
...
### 2022-2-03 – All versions through 3.4.0 – JSON Serialize Function in post-processing Pipeline won't process [CRIBL‑8013]
...
### 2022-02-02 – Versions 3.0.0 through Current – Upgrading a Pack overwrites Lookup and sample-data customizations [CRIBL‑7998]
...
### 2021-11-24 – v3.2.0 through Current – With processing Pipelines in QuickConnect, Preview Full doesn't show Functions' results [CRIBL‑7113]
