...
The **Files** tab enables you to specify a list of directories and files to actively monitor. There are two discovery modes:

- **Manual**
- **Browse** 

![File tab -Manual mode](ed-file-manual-windows.c0151cfc78.png)
{border="true"}

![File tab -Browse mode](ed-file-browse-win.9f12e0232a.png)
{border="true"}

**Manual** mode provides the following options:
...
![Host info / Metadata collected](ed-host-win-info.f1a8f39f08.png)
...
![Disks tab](ed-hosts-diskswin.cb2dcc6aad.png)
{border="true"}
...
![DNS tab](ed-hosts-dnswin.adcd990317.png)
{border="true"}
...
![File Systems tab](ed-file-systemswin.b2214934e7.png)
{border="true"}
...
![Groups tab](ed-hosts-groupswin.ee33f63331.png)
{border="true"}
...
![Interfaces tab](ed-hosts-interfaceswin.b7f1099627.png)
{border="true"}
...
![Users tab](ed-hosts-userswin.4b749969f8.png)
{border="true"}
