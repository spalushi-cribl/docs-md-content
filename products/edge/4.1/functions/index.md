...
![Functions stack in a Pipeline](functions-screen.f231792bb6.png)
...
![Expanded Group Actions submenu](fn-group-expand.23945657eb.png)
{scale="50%"}
...
![Drag-and-drop target](fn-group-drag.7caf1d0bf0.png)
{border="true"}
