...
- [Create a Fleet](fleets) that is only for Windows Nodes, and constrain Windows Sources
  to that Fleet.
...
- If you're collecting Windows Events Logs in JSON format, you may experience
  ...
  Events Logs Source, or upgrade Cribl Edge to 4.8.x or newer and toggle off
