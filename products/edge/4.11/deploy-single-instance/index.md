...
either as a [single instance](#run-edge), [alongside Cribl Stream](#collocated),
...
|---|---|
| RedHat, CentOS, Ubuntu, AWS Linux, Suse | ~1Ghz processor, 512MB RAM, 5GB free disk space (more if [persistent queuing](persistent-queues) is enabled on Edge Nodes) |

> Edge Node sizing depends on specific workload requirements and organizational constraints.
> For more detailed information about requirements for complex deployments, see [Deployment Planning](deploy-planning).
{.box .info}
...
> To configure a Leader Node, see [Set Up Leader and Edge Nodes](setting-up-leader-and-edge-nodes).
>
{.box .info}
