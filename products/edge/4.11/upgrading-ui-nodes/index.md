...
You can upgrade the Nodes in a Fleet from the **Fleets**
...
1. In the Leader Node's sidebar, select **Fleets**.
...
3. The [**Target Version** window](upgrading-ui-status#explore-the-target-version-window) will open. Click the
   **Upgrade target version** drop-down and select a version.
