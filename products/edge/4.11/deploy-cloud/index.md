...
In a [Cribl.Cloud](https://cribl.cloud/signup) deployment, Cribl assumes responsibility for hosting and managing your Cribl Edge infrastructure.
...
but does not have the option to have multiple Fleets.
...
> If you're new to Cribl Edge, please see [Cribl Edge Basic Concepts](basic-concepts) and the [Getting Started Guide](getting-started-guide) for help onboarding. Cribl.Cloud always runs in Distributed mode – for details about this, see [Simplified Distributed Architecture](cloud-vs-self-hosted#distributed).
>
{.box .info}
