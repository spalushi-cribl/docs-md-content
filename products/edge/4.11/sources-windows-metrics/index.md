...
4. Optionally, you can adjust the [Host Metrics](#host), [Process Metrics](#metrics), [Processing](#processing) and [Advanced](#advanced-tab) settings, or [Connected Destinations](#connected) outlined in the sections below.
...
- If toggled on, the Windows Metrics Source will collect events using `PS cmdlets`.
