...
distributed:
  ...
  master: # [object]
    disableSNIRouting: # [boolean] Whether SNI routing is enabled. See Environment Variables (https://docs.cribl.io/stream/environment-variables/#environment-variables) before changing this setting.
    host: # [string] Instance host address.
    port: # [number] Instance post number.
    forwardToLeaderApi:  # [boolean]
    tls: # [object]
      disabled: # [boolean]
      ...
      passphrase: # [string] The passphrase for the private key file specified in privKeyPath. 
    ...
    failover: # Use if resiliency is set to failover.
      volume: # [string] Shared Network File System (NFS) volume. Example: `/mnt/cribl`.
      missedHBLimit: # [number] Number of Lease refresh periods that can elapse before standby Leader Nodes attempt to promote themselves to primary.
      period: # [number] How often the primary Leader refreshes its hold on the Lease file.
