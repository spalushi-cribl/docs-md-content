...
If you're managing your own  Cribl Edge deployment (single-instance [Stream](/stream/deploy-single-instance/)/[Edge](/edge/deploy-linux#run-edge/) or distributed [Stream](/stream/deploy-distributed/)/[Edge](/edge/fleet-management/)), you can create and securely share bundles with Cribl Support, either from the UI or via the CLI. 
