...
Explore the Cribl Edge UI on Windows.
...
> When using PowerShell cmdlets, the environment variables displayed in this tab might be inaccurate. For details, see [Other](fleet-settings#other) Limits.
{.box .warning}
