...
When you create a new Notification, its default target type will be **System Messages**. When an event occurs in Cribl Edge to trigger a Notification condition, you will see an indicator in the <img className='inline' src="/images/page/icon-messages.svg"></img> **Messages** icon. Select the icon to open the **Messages** drawer and view the Notification details.
