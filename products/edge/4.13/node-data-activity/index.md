...
Monitor and troubleshoot Edge Node activity.
...
![Node info panel](node-info-panel-gif-4.12.2.gif)
{border="true"}

> With **Enable teleporting to Nodes** enabled in Fleet Settings, the GUID becomes a link.
...
![Node info panel data activity](node-info-4.12.2.png)
...
|Field|Description|
|-----|-----------|
|Node info |Detailed information for this Node: <ul><li>GUID</li><li>CPUs</li><li>Host</li><li>RAM</li><li>IP Address</li><li>Last Heartbeat</li><li>Health</li><li>Started</li><li>Sources</li><li>Destinations</li><li>Fleet</li><li>Config version</li><li>Edge version</li><li>Msg</li></ul>|
