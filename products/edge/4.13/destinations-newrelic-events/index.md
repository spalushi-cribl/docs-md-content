...
## Configure Cribl Edge to Output Events to New Relic
...
**Events-per-request limit**: Maximum number of events to include in the request body. Defaults to `0`,  allowing unlimited events.
