...
Events generated by the [Windows Metrics](sources-windows-metrics) Source include metrics metadata to designate dimension and metric fields. The `host` field contains the hostname, and is included as a dimension in all of them. 
