...
The [upgrading framework](upgrading-ui-leader) allows Edge Nodes to pull down upgrade
...
The [**Node to explore**](explore-edge-linux#explore-tab) field returns only the first
