...
Leaders on v.4.2.x are compatible with Edge Nodes on v.4.1.2 and newer. Due to a security update, Edge Nodes running on v.4.0.4 cannot receive configurations from v.4.2.x Leaders. For details, see [Upgrading to 4.2.x](upgrading-troubleshooting#upgrade-42).
