...
- Evaluate changes or updates in your OS that could interfere with the upgrade, such as any software that might block connections. Ensure the Cribl process is allowlisted and allowed to execute without limitations to facilitate a smooth installation.
...
- [Specific considerations for upgrading Windows Environments](upgrading-windows-manually#windows-upgrades)

**Keep Reading**

- [Upgrading via UI](upgrading-ui-leader)
