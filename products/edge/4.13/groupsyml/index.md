...
group_id: # [object] 
  ...
  upgradeVersion: # [string] Upgrade version - Upgrade version to follow for this Fleet
  maxWorkerAge: # [string] Time to keep disconnected Edge Nodes - Maximum time to keep disconnected Edge Nodes before deleting. Format examples: 8h, 5d, 1w. Defaults to days if not specified. If left blank, defaults to 1 day.
