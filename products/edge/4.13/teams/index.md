...
1. If you have SSO configured in your Organization, then in **Mapping IDs**, you can provide a list of IDP group names for the Team.
   Use them when integrating with SSO to map Workspace- and Product Permissions with [IDP groups](sso-initial-steps#idp-groups-teams).
...
The main Teams page displays the Teams configured in your Organization.
