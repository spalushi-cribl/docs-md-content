...
[Snippet not found: content/edge/4.13/snippets/_windows-supported-versions.md]
...
1. Ensure that the required ports are available (see [Network Ports](deploy-planning#fleet-checklist)).
