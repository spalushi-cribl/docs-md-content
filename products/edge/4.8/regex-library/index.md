...
![Regular Expression Library](regex-lib.2b20eebf08.png)
{border="true"}

## Using Library Patterns  {#how-does-it-work}

As of this version, the Library contains 25 patterns shipped by Cribl Edge. To insert a pattern into a [Function](functions)'s regex field, first click the pop-out or Edit icon beside that field.
...
![Inserting a pattern from the Regex Library](regex-library-typeahead.8120a4a0e8.png)
{border="true"}
...
![Adding a custom pattern to the Regex Library from a Function's Regex modal](regex-library-custom-save.73980dd222.png)
{border="true"}
