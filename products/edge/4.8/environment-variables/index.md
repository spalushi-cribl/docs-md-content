...
> To configure an HTTP(S) proxy to use for your Sources and Destinations, refer to the System Proxy Configuration doc ([Stream](/stream/proxy-config),[Edge](/edge/proxy-config)).
>
{.box .info}
