...
| Version 4.3.0 and older | Re-run a Windows installer from the filesystem. Upgrades, backups, and rollbacks, are not supported in the UI for Cribl Edge versions 4.3.0 and older. For details, see [Manually Upgrading Windows Edge Nodes](upgrading-windows) |
