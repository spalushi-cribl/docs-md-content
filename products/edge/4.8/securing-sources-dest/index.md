...
You can use certificates to authenticate Cribl Edge to external data senders and receivers. You configure this at the Fleet level, as follows:
...
2. Open **Fleet Settings** (top right) > **Security** > **Certificates**.
