...
When you log into your Cribl.Cloud Organization, navigate to the [Network Settings](cloud-portal#network-settings) link. Here you can check and manage connectivity details – [Data Sources](cloud-portal#data-sources), [Access Control](cloud-portal#acl), and [Trust](cloud-portal#trust) relationships – for your Cribl-managed Cribl.Cloud Workers.
...
Cribl.Cloud offers detailed role-based access control (RBAC) to ensure appropriate permissions and security. For details on how to invite and manage the roles for Members of your Organization, see [Managing Cribl.Cloud](cloud-managing).

## Set Up Your Preferred Authentication Method

Cribl.Cloud Enterprise offers a range of secure and convenient login options to fit your organization's needs. Options include: 
...
Cribl.Cloud provides built-in encryption for data at rest, ensuring that your information remains secure within its infrastructure.  For an extra layer of protection, consider encrypting your data while it travels between Cribl.Cloud and your data Sources and Destinations. For details, see [Data Encryption](/stream/securing-data-encryption) and [Data Decryption](/stream/securing-data-decryption). 

## Configure a Key Management Service (KMS) 
Cribl.Cloud Enterprise offers a Key Management Service (KMS) that strengthens the security of your data. KMS securely manages the encryption keys used to protect sensitive information on Worker Groups and Nodes within Cribl.
