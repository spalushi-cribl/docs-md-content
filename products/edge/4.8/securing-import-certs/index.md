...
2. Open your TLS/SSL certificate file. (The self-signed certificate example in [Configure SSL Certificates](securing-ssl) used the placeholder name `myCert.pem`.)
...
5. Open your private key file. (The self-signed certificate example in [Configure SSL Certificates](securing-ssl) used the placeholder name `myKey.pem`.)
