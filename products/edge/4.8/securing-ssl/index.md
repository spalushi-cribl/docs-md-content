...
You can secure access to the Cribl Edge API and UI by configuring Secure Sockets Layer (SSL). Do this on the Leader, to secure inbound communications to the Edge Nodes.
