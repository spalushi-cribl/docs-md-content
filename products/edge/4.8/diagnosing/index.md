...
1. Make sure the relevant Fleet's **UI Access** toggle is on. 
1. In the **Edge Nodes** column, click the displayed number to access the **Workers** (Cribl Stream) or **Edge Nodes** (Cribl Edge) page.
1. In the **GUID** column, click the link for the Edge Node you're debugging. 
1. Look for the purple border to confirm that you've teleported to that Edge Node.
1. Click **Edge Node Settings** (top right) > **Diagnostics** (lower left) > **Diagnostic Bundle**, and click **Create Diagnostic Bundle**.
