...
7. If you are _not_ [mapping Teams](sso-initial-steps#linking-idp-groups-with-teams) to IDP groups,
...
1. On your Cribl.Cloud portal's [Organization page](cloud-portal#organization) select the **SSO** tab, then the **OIDC** lower tab. 

2. The **Web Application Settings** are prefilled for you, so you only need to fill in the **Cribl Cloud SSO Settings** section with the following details from your IDP client configuration:
   - Client ID
   - Client Secret
