...
PowerShell-based collection for System State, Windows Metrics, and Windows Event Log Sources causes high resource utilization and incomplete data collection when **Use Windows Tools** is enabled. To mitigate this:

1. Upgrade to Cribl Edge `4.12.x` or newer.
1. Disable **Advanced Settings** > **Use Windows Tools** (default). 
