...
([Stream](/stream/deploy-distributed), [Edge](/edge/setting-up-leader-and-edge-nodes)) with a [certain plan/license tier](https://cribl.io/pricing/).
...
>
> When you first install Cribl Edge with the prerequisites to enable RBAC (Distributed deployment with a [certain plan/license tier](https://cribl.io/pricing/)), you will be granted the **admin** Role. Using this Role, you can then define and apply additional Roles for other users.
> 
