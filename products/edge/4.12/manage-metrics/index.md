...
1. **[Manage metrics](#manage-metrics):** Use the interface to drop and aggregate metrics. Cribl Edge automates most of the configuration process. Select the metrics you want to aggregate, and Cribl Edge will automatically add Functions to your Pipeline with an initial configuration based on your selection.
