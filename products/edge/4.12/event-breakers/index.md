...
To access the Event Breakers management interface navigate to **Products** > **Cribl Edge** > **Fleets**. Select a Fleet, then go to **More** > **Knowledge** > **Event Breaker Rules**. On the resulting **Event Breaker Rules** page, you can edit, add, delete, search, and tag Event Breaker rules and rulesets, as necessary.
