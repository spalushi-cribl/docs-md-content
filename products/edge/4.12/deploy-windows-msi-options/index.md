...
Ensure you launch the installer (MSI) from a command prompt or PowerShell window that is running with full administrator privileges. Simply being logged in as an `administrator` might not be sufficient; you need to explicitly `Run as administrator`.
