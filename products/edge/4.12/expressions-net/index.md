...
- For network flows coming from the Cribl Edge [NetFlow & IPFIX Source](sources-netflow), use the protocol name as-is – the Source will provide it in correct form.
