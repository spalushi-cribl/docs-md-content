...
Source and Destination Notifications operate based on information for the whole Fleet.
For example, if you configure a Source Low Data Volume Notification in a Fleet of 10 Edge Nodes,
Cribl Edge will send a Notification when the sum of data for all 10 Edge Nodes is below the configured threshold.
