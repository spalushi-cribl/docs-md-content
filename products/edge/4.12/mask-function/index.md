...
> If you need to send the unmodified values to a Destination, such as an archival stores, you can use the **Destination** field for the associated [Route](routes) to narrow the scope of the Mask Function.
>
{.box .info}
