...
The Fold Keys Function is a simpler version of the [Eval Function](eval-function), designed specifically to group related fields by a common separator in their names. If you're familiar with Cribl Search, the Function behaves like the [foldkeys](/search/foldkeys) operator, but for use within Cribl Edge.
