...
If you have an on-prem Cribl Edge environment and a Cribl.Cloud account on
[certain plan/license tiers](https://cribl.io/pricing/), you can configure
**Connected Environments**. This enables you to manage credit consumption for all
of your Organizations with the [Cribl.Cloud billing model](cloud-billing) instead of
licensing.
...
To connect existing on-prem Cribl Edge Distributed deployments to Cribl.Cloud,
select an on-prem Leader that is running Cribl Edge 4.8.2 or newer, then use the
following steps.
...
How you set this variable depends on your deployment.
 ...
 - For example, if your Cribl Edge deployment is running in a container, 
...
ensure you are comfortable setting up and managing Cribl Edge Leader HA. See
