...
Access the **Metrics Levels** setting by navigating to the **Worker Group** > **Fleet Settings** > **System** > **Metrics Levels**.
...
`/system/metrics` is Cribl Edge's primary public metrics endpoint, which returns most internal metrics. Many of these retrieved metrics report configuration only, not runtime behavior. For details, see our [API Docs](/api/).
