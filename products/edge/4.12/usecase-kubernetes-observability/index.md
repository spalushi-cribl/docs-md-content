...
Cribl Edge includes a powerful [Kubernetes Explorer UI](/edge/explore-edge#kubernetes) that allows you to visualize and analyze your Kubernetes cluster data in real-time. This UI provides a comprehensive view of your deployments, pods, containers, metrics, and events, all in one place.
