...
> This Function is deprecated as of Cribl Edge 4.7, and will be removed in the next major version. Please use the [Eval](eval-function) Function instead.
>
{.box .warning}
...
![Example event setup](trim-timestamp-paste-4101.png)
{border="true"}
...
![Example event, saved and transformed](trim-timestamp-out-4101.png)
{border="true"}
