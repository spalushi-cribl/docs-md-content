...
`CRIBL_DIST_LEADER_URL=tcp://criblmaster@masterHostname:4203 ./cribl start`
...
The `-H` and `-p` parameters are required. For other options, see the [CLI Reference](cli-reference#mode-Edge). Here is an example command:
