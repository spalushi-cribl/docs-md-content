...
1. Log in to Cribl.Cloud to open the [Portal Page](cloud-portal#workspaces).
...
1. Navigate to **Processing** > **Packs** and click **Add Pack**. From the drop-down, select **Import from Git** to open the **Import** modal.
1. For the **URL**, enter:
    ```
...
1. For the **New Pack ID**, enter: 
    ...
    ```
1. Click **Import** to close the modal. Cribl Edge will take a little time to finish importing the Pack.
...
1. Run the following command, replacing `<cribl_org_id>` with your Cribl.Cloud [Organization ID](cloud-portal#organization): 
