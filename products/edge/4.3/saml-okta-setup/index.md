...
On your Cribl.Cloud portal's [Organization page](cloud-portal#organization) > **SSO** tab, select the **SAML** lower tab. 

![SSO > SAML lower tab](cloud-sso-saml-tab.6b71417bc6.png)
{border="true"}
