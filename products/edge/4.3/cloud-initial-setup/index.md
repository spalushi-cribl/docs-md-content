...
2. Select an AWS Region to host your Cribl.Cloud Leader and Cribl-managed Workers. Cribl currently supports the following Regions: `US West (Oregon)`,  `US East (Virginia)`, and `Europe (Frankfurt)`.
3. Bookmark your Cribl.Cloud portal page, for all that follows.

![Create Organization page – selecting a host Region](se-cloud-select-region.2f2a7e4b37.png)
{scale="50%"}
