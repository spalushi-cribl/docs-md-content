...
### 2023-10-05 - v.4.3.0 through Current - The Microsoft Windows Installer (MSI) does not create an Edge desktop shortcut [CRIBL-20504]
...
### 2023-07-16 – v.4.2.0 through Current – After upgrading, Monitoring dashboards are not visible for users with `GroupRead` and `GroupCollect` Policies [CRIBL-18925]
...
### 2023-06-21 – v.3.5.2–4.3.0 – Datadog Agent Source fails to receive metrics [CRIBL-18281]
...
### 2023-03-21 – v.4.1.0 through Current – Unable to bind `CRIBL_DIST_LEADER_URL` to an IPv6 address [CRIBL-16284]
