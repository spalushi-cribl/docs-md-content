...
![Edge Node tab](ed-edge-node-tab.443b4220d0.png)
{border="true"}
...
![Options to add or update an Edge Node](ed-add-new-node.c8b1d35735.png)
{border="true"}
...
Click the **Mappings** tab (**Manage Mappings** page) to display status and
controls for the active [Mapping Ruleset](fleets#mapping).
