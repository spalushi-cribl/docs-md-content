...
> Manual Password Replacement is for on-prem deployments only. For Cribl Edge in Cribl.Cloud, Cribl recommends setting up [Fallback Access](cloud-sso#fallback); if you do need to reset your password, you must contact Cribl.
>
{.box .cloud}
...
[Snippet not found: content/shared/4.3/snippets/_api-server-settings-authentication.md]
