...
![Adding `__syslogout`, `_time` to construct a valid syslog message](syslogout-add-time-how.f676f8d33b.png)
{border="true"}
...
![Adding syslog decorations to `_raw`](syslog-raw-out.f956857fee.png)
{border="true"}
