...
![Firewall tab](ed-firewall-win.c138f286d0.png)
{border="true"} 
...
![Listening Ports tab](ed-listening-ports-win.3737b61aeb.png)
{border="true"}
...
![Logged-In Users tab](ed-logged-users-win.7119d74fac.png)
{border="true"}
...
![Services tab](ed-services-win.1c7b5a1ba0.png)
{border="true"}
