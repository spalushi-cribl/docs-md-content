...
This maintenance release of Cribl Edge includes bug fixes and important updates.
...
- Reverted the Fleet **Number of metrics allowed** default setting from `100,000` back to `1,000,000`. This change addresses recent customer reports of Edge Node crashes related to metrics processing. This temporary fix provides stability for high-volume environments while we work on a more permanent solution for handling high-volume metrics.
