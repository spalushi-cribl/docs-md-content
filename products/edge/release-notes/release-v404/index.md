...
CRIBL-5463 Webhook Destination now supports OAuth authentication.
...
CRIBL-14342 **New Fleet** creation modal provides a new **Description** field. Also, **Fleets** list page now consolidates several columns into a new expandable **Details** column.

## Breaking Change

> CRIBL-14447 Packs developed for Cribl Edge v.4.0.x and above do not work in v.3.5.x. Cribl recommends that you upgrade to v.4.0.x to continue using these Packs. If you cannot upgrade, please consult Cribl Community Slack's `#packs` channel for other options.
>
{.box .warning}
...
CRIBL-14274 Amazon Kinesis Data Streams Source provides new `Records limit per call` and `Total records limit` fields, which you can tune to accelerate data collection.
...
CRIBL-14258 In Leader's teleported view of individual Workers and Edge Nodes, the **Restart** button is moved to a clearer location.
