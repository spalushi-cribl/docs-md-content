...
Cribl Edge provides metrics and health indicators to monitor your Source persistent queue through the **Status** tab on your Source. The **Status** tab aggregates metrics and health from all Worker Processes, allowing you to assess the health of your persistent queues and the status of the Source in real time.
...
1. On the top bar, select **Products**, and then select **Cribl Edge**. Under **More**, select **Sources**.
