...
> We use the name `Windows` for demonstration purposes and simplicity. Since Fleet names must be unique across your deployment, you should select a name that makes sense in practice. For better practices on designing and naming your Fleets, see the [Design Fleet Hierarchy](fleets-design) doc.
>
{.box .info}
