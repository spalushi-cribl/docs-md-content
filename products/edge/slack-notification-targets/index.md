...
**Retry timed-out HTTP requests**: When toggled on, Cribl Edge to automatically retries HTTP requests that have timed out. Default is toggled off. Enabling this option exposes the following settings:
