...
Monitor your infrastructure and visualize performance using Grafana.
...
1. For all of the Sources, select **Processing Settings > Pre-Processing**, then
...
Access the `prometheus_metrics` Pipeline by selecting **More** > **Pipelines** in the Fleet submenu.

![Customizing the Pipeline's dimensions](usecase-grafana-3a-4101.png)
{border="true"} 
