...
![Functions stack in a Pipeline](functions-screen-2511.png)
...
* Resolve account names from Windows SID (Cribl Edge only):
[Windows SID Lookup](windows-sidlookup-function)
