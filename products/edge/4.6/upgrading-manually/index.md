...
2. Uncompress the new version on top of the old one, e.g., in the `/opt/cribl-edge` directory: 
...
Explicit rollback might be necessary if an [automatic rollback](upgrading-ui#backup-and-rollback)
