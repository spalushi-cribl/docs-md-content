...
Cribl Edge supports sending events to SignalFx, now rebranded as Splunk Observability Cloud.
...
**Output ID**: Enter a unique name to identify this SignalFx Destination. If you clone this Destination, Cribl Edge will add `-CLONE` to the original **Output ID**. 
