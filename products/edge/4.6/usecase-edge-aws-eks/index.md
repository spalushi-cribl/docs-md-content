...
1. Log into your [Cribl Deployment](https://docs.cribl.io/stream/deploy-planning/)
   in a self-hosted deployment, or log into Cribl.Cloud, and click **Manage Edge**.
1. In Edge, click the Fleet for which you want to access deployment
   details.
1. To update the API Server Settings, click **Manage** then **Fleet Settings**
   in the submenu.
...
1. Under **API Server Settings**, click **General**.
1. In the **Host** field, replace the default value with `0.0.0.0`.
1. Click **Save**.
...
1. Click **Add/Update Edge Node** and select **Kubernetes**.
