...
1. In Cribl Edge, in the sidebar, select **Fleets**, then choose a Fleet.
...
1. The [Packs Dispensary](https://packs.cribl.io/) will open in a drawer.
   ...
   ![Packs Dispensary drawer open over Cribl UI, with a list of available Packs](packs-dispensary-drawer-full-4.13.png)
...
Do it the same way you would when working directly in any Fleet.
...
If you've modified the Pack, Cribl Edge will not overwrite it during upgrading,
...
1. If you modified default Cribl Edge Knowledge Objects (for example, lookup files),
