...
### 2023-12-01 – v4.4.0-v.4.4.1 – Edge-only Sources are unavailable in standalone Edge instances [CRIBL-21443]
...
### 2023-11-23 v.4.0.0–4.4.3 – Sources incorrectly report failure [CRIBL-21690]
...
### 2023-11-15 – v4.4.0 through Current – With Leader HA/Failover, creating diag bundles via CLI produces incorrect results [CRIBL-21258]
...
### 2023-11-09 – v.4.2.1 through Current – Edge upgrades occasionally fail when Fleets contain a large number of Nodes [CRIBL-20067]
...
### 2023-11-08 – v.3.5.x – Collecting Forwarded Event logs from the Windows Event Logs Source results in an error [CRIBL-14869]

**Problem**: The Windows Event Logs Source cannot collect Forwarded Event logs when **Event format** is toggled to **JSON** in the Source configuration. You will see the error `"Collection from the 'ForwardedEvents' log is only supported in XML mode"`.  

**Workaround**: Toggle the **Event format** setting to **XML**.

**Fix**: In Cribl Edge 4.4.0.
...
### 2023-08-23 - v.4.0.0 through Current - Packs installed in Fleets are not visible to Subfleets. [CRIBL-19676]
...
{{< id `CRIBL-18970` >}} {{< id `CRIBL-20113` >}}

### 2023-07-18 – v.4.2.0–4.2.1 – Product-level Editor Permissions do not allow a commit/deploy action on the Worker Groups/Fleets page [CRIBL-18970, CRIBL-20113]
...
**Fix**: Version TBD. CRIBL-18970 is closed and expanded to CRIBL-20113.
...
### 2022-08-16 – All versions through 4.3.0 – Splunk HEC shows higher outbound data volume than other Splunk Destinations
