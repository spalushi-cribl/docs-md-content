...
**Max data size**: The maximum amount of disk space the data can consume. Once
the data reaches the amount set here, Edge will delete data starting with the
oldest buckets.

**Max data age**: The length of time Cribl Edge will retain data. Edge will
delete data that exceeds the max age entered in this field. Example values are
`2h`, `4d`. The default value is 24 hours (`24h`).
