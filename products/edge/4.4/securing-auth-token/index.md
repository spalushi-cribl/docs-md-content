...
Cribl **strongly recommends** that when you first install Cribl Edge, you change the Leader's auth token value from the default `criblmaster` to a unique secure value.
