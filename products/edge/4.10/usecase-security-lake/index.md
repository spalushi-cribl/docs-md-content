...
## Set Up Cribl Edge {#set-up-stream}
...
1. Select the name of the Fleet whose Edge Nodes you want to send data to Amazon Security Lake. (For this example, we'll use the `default` Fleet.) 
...
1. For the **New Pack ID**, enter: 
    ...
    ```
1. Select **Import** to close the modal. Cribl Edge will take a little time to finish importing the Pack.
