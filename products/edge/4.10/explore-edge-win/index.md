...
## Access Cribl Edge on Windows {#home}

When you first log into Cribl Edge on Windows, you'll land on the **Edge Home**
page. From here, select **Edge Nodes** and open the link to a specific Edge Node
to teleport into it. See [Teleport into an Edge Node](managing-edge-nodes#teleport-into-an-edge-node)
for more details on this process.

Now that you're teleported into a specific Node, you can view the metrics and
log data that the Node has auto-discovered, and can manually discover and
explore other data of interest. 

![Edge on Windows](windows-edge-home.png)
...
You can control the collection method for Process Metrics using a configuration option in the **Fleet Settings** > **Limits** > **Other** section. This setting allows you to choose between using PowerShell cmdlets or the more efficient native module.

> When using PowerShell cmdlets, the environment variables displayed in this tab might be inaccurate. For details, see [Other](settings-group-fleet#other) Limits.
{.box .warning}


![Processes tab](windows-explore-processes.png)
{border="true" scale="75%"}
...
![Process details](windows-process-overview.png)
{border="true" scale="75%"}
...
![All detail link](windows-process-details.png)
{border="true" scale="75%"}
...
![Search tab](windows-allowlist-search.png)
{border="true" scale="75%"}
...
![Event Breakers tab](windows-event-breakers.png)
{border="true" scale="75%"}
...
![New File Monitor modal](ed-file-monitor-discover-win-4101.png)
{border="true"}
