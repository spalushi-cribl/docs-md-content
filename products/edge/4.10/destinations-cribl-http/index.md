...
>
>For guidance on when to choose this Source versus the [Cribl TCP](destinations-cribl-tcp) Destination, see [Interoperation Protocols](/suite/reference-arch-full-suite/#protocols).
{.box .info}
