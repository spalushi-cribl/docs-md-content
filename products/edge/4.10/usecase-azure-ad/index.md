...
1. In Cribl Edge, navigate to **Settings** > **Global**.
...
5. In the **Audience (Relying Party ID)** field, enter your Cribl Edge Leader's base URL. Do **not** append a trailing slash.
...
7. If your Cribl Edge is in Enterprise Distributed mode:
