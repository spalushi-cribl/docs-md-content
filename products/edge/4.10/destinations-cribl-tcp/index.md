...
>
>For guidance on when to choose this Source versus the [Cribl HTTP](destinations-cribl-http) Destination, see [Interoperation Protocols](/suite/reference-arch-full-suite/#protocols).
{.box .info}
