...
AppScope is included in your Cribl Edge installation. One or two [AppScope Sources](sources-appscope) are enabled right out-of-the-box; they are configured to send data to Cribl Edge or Cribl Stream on the same host.
...
2. Then, on the **Fleets** submenu, select **More**, then **Knowledge**, then **Appscope Configs**.
