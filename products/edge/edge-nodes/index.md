...
- Edge Node bootstrapping/update: HTTPS 443.
...
> The Leader is unaware of Edge Nodes' platforms (such as Linux or Windows) within a Fleet. So the ConfigHelper omits platform-specific limitations. Therefore, when you manage Edge Nodes on heterogeneous platforms, create a Windows-specific Fleet and mapping. See [Design Fleet Hierarchy](fleets-design). 
>
{.box .warning}
