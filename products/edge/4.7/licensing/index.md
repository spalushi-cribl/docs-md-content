...
> This page does not apply to Cribl.Cloud plans. For basic information about Cribl.Cloud Enterprise and Standard plans, see [Cloud Pricing](deploy-cloud#pricing).
>
{.box .cloud}
...
### Airgapped Deployments {#airgapped}
...
If you are connecting Workers/Edge Nodes in a Cribl Stream Cloud [hybrid deployment](cloud-enterprise#hybrid), you are granted additional exemptions to prevent double billing:
...
to fall back to the Sales Trial or Free type. An expired Sales Trial license
cannot fall back to a Free license.

To delete your expired license:

1. Select **Settings** then **Licensing**.
1. Locate your expired license, and click **Delete license**. 
1. Restart the Leader.

> Upon expiration of a paid license, if there is no fallback license, Cribl Edge
