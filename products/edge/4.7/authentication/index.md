...
> Manual Password Replacement is for on-prem deployments only. For Cribl Edge in Cribl.Cloud, Cribl recommends setting up [Fallback Access](oidc-okta-setup#set-up-fallback-access); if you do need to reset your password, you must contact Cribl.
>
{.box .cloud}
