...
**DNS server(s) overrides**: IP address(es), in [RFC 5952](https://tools.ietf.org/html/rfc5952) format, of the DNS server(s) to use for resolution. IPv4 examples: `1.1.1.1`, `4.2.2.2:53`. IPv6 examples: `[2001:4860:4860::8888]`, `[2001:4860:4860::8888]:1053`. If this field is not specified, Cribl Edge will use the system's DNS server.
...
![DNS Lookup: Eval Function](dns-lookup-eval.f1ac07d05d.png)
{border="true"}
...
![DNS Lookup: multiple record types](dns-lookup-direct.363678d37e.png)
{border="true"}
