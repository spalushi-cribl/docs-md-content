...
The running Leader application must have the connectivity and permissions to access the filesystem location.

### Selecting a Package Source

Once you're in **Global Settings**, you will select between **CDN** and **Path** for your upgrade (in an
