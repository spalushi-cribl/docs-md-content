...
If you don't enable this option and a Source-state Notification trigger condition persists beyond your configured **Time window**, Cribl Edge will send a new Notification, once per **Time window** interval.
