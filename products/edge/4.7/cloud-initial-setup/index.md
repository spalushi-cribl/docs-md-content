...
1. On the **Create your Organization** page, enter an **Organization name** (a friendly alias for the randomly generated ID that Cribl will assign to your Organization), and then select an AWS Region to host your Cribl.Cloud Leader and Cribl-managed Workers. Cribl currently supports the following Regions:
   - `US West (Oregon)`
   - `US East (Virginia)`
   - `US East (Ohio)`
   - `Europe (Frankfurt)`
