...
> By design, you can readily share Packs **across** Fleets by [copying](#copy) them between each other.
>
{.box .success}
...
You can install Dispensary Packs directly through Cribl Edge's user interface, as outlined in [Import from Git Repos](#git) above. However, if you prefer, you can click through to any Dispensary repo release page, download the corresponding `.crbl` file, and then [upload the file](#file) into Cribl Edge.
...
You can easily share Packs in a [distributed deployment](/stream/deploy-distributed) by copying them between Fleets as described here or [using the Cribl API](/api/copy-export-install-packs#copy-packs).
...
1. Select the Fleets to copy the Pack to.
