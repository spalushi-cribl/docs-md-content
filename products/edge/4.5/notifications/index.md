...
The threshold for the Notification to trigger is: Cribl Edge detected a blocked or dropped state during ≥ 5% of the trailing **Time window** that you configure in the [Notification Settings](#notification-settings-d).
...
This tab is where you centrally configure and manage targets that are available across Cribl Edge – to all Sources, Destinations, and license-based Notifications. See [Configuring Targets](notifications-targets) for details.
