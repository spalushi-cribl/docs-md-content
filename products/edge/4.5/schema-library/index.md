...
- [JSON schemas](#schema-library) for validating JSON events. This page outlines how to manage these in the UI at **Knowledge** > **Schemas**.
...
![Schema validation results for the above events](cribl-json-schema-validator.b8d0430da9.png)
{border="true"}
