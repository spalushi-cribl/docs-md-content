...
The Clone Function clones events, with optional added fields. Cloned events will be sent to the same Destination as the original event, because they are in the same Pipeline. If your Destination is an [Output Router](destinations-output-router), you can use filters to send cloned events to different Destinations. 
