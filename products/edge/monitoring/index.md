...
Monitor health and metrics in Cribl Edge.
...
When you first log in to Cribl, you can view the health status of Edge Fleets
in the **Worker Groups & Fleets** area.

![Workspace Landing Page](workspace-monitoring.png)
{border="true" scale="75%"}

From this page, select **Cribl Edge** to get to the Edge home page.

## Monitor Health on the Edge Home Page

The **Edge Home** page is where you can view aggregate data for all Fleets, Subfleets and Edge
Nodes. The charts display information about traffic in and out of the system. 
...
By default, Cribl Edge does not send metrics for the `host`, `source`, `sourcetype`, `index`, and `project` fields.
...
- Per Fleet, in **Fleet Settings > System > General Settings > Limits > Metrics**.
