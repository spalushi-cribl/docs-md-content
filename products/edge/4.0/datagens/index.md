...
![Preview pane – add samples via paste,  attach/upload file, or live capture](cribl-datagens-landing-2.3.80f38f6a16.png)
{border="true"}
...
![Verifying datagen file creation](cribl-datagen-list-2.3.2eeabf2f52.png)
{border="true"}
