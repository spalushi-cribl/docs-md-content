...
As data travels through a Cribl Edge Pipeline, it is operated on by a series of Functions. Functions are fundamentally [JavaScript](https://developer.mozilla.org/en-US/docs/Web/JavaScript) code.

Functions that ship with Cribl Edge are configurable via a set of inputs. Some of these configuration options are literals, such as field names, and others can be JavaScript [expressions](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Expressions_and_Operators#Expressions).
