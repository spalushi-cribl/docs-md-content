...
You access the Event Breakers management interface from Cribl Edge's top nav under **Processing** > **Knowledge** > **Event Breakers**. On the resulting **Event Breaker Rulesets** page, you can edit, add, delete, search, and tag Event Breaker rules and rulesets, as necessary.
