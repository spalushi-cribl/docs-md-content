...
When you first log into your distributed deployment, you will be greeted with tiles prompting you to choose a product. The Cribl Edge tile displays basic configuration details, including number of Fleets, Subfleets, Edge Nodes, events and bytes over time.
...
On top of the **Bytes** chart, you can change the display's granularity from the default `last 5 min`, selecting a variety of time ranges from `1 min` up to `1 day`. (The latter covers the preceding 24 hours, and this maximum window is not configurable.) 
...
![Health Overview](ed_edge_teleport_health.ea4a0c2186.png)
{border="true"}
...
From the **Health** page's top nav, open the **Data** submenu to isolate throughput for any of the following:
...
![Monitoring > Data submenu (Pipelines selected)](ed_monitoring-data-submenu.c898257ee6.png)
{border="true"}
...
![Throughput details](ed_monitoring_details.b14d5114c6.png)
{border="true"}
...
![Manage Logging Levels page](ed_log-levels-composite.542e385968.png)
{border="true"}
