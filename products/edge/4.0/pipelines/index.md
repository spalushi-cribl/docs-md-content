...
To create a new Pipeline, or to import an existing Pipeline to a different Cribl Edge instance, click **+ Pipeline** at the upper right. The resulting menu offers three options:
...
![Creating or importing a Pipeline](pipeline-add-options.460633578d.png)
{border="true"}
...
![Pipelines and Route inputs](pipelines-screen-cropped-2.3.e421c4dbf3.png)
{border="true"}
...
![Preview on hovering over the bottom Pipeline (highlighted in gray)](pipeline-functions-preview.3dda208330.png)
{border="true"}
...
![Pipeline Functions](pipeline-functions.85084751b9.png)
{border="true"}
...
Once you've clicked the gear button to enter [Pipeline Settings](#pipeline-settings), you can click **Edit as JSON** at the upper right to edit the Pipeline's definition in a JSON text editor. In this mode's editor, you can directly edit multiple values. You can also use the **Import** and **Export** buttons here to copy and modify existing Pipeline configurations, as `.json` files.

![Advanced Pipeline Editing](pipeline-advanced-editing-mode.cee5344165.png)
...
![Pipeline > Actions menu](pipelines-copy.beb4d374c4.png)
{border="true"}

Copying a Pipeline displays the confirmation message and the (highlighted) Paste button shown below.

![Paste button for copied Pipeline](pipelines-paste-button.4d6ac76252.png)
{border="true"}
...
![Saving/renaming a pasted Pipeline](pipelines-paste.ca6a02accb.png)
{border="true"}
