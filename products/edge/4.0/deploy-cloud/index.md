...
**Version**: Your deployed Cribl Edge version. 
...
Compared to self-hosted Cribl Edge, the **Settings** > **Worker Processes** and **Settings** > **Distributed Settings** links are omitted, as are **Worker Groups** and **Mappings** links.
...
You can also add Workers, and reassign them to different Worker Groups, by easily [auto-generating](/stream/deploy-workers#ui) command-line scripts within Cribl Edge's UI.
