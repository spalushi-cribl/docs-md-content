...
> To avoid data loss, Cribl recommends that you use the  `negotiateProtocolLevel = 0` setting shown above. Depending on your environment, enabling `negotiateProtocolLevel` could cause Cribl Edge to not accept data from the forwarder. 
>
{.box .warning}