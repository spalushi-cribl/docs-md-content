...
**Extract directory**: The AppScope binary's contents will be extracted into the directory that you specify here. Cribl Edge will create the directory if it doesn't already exist. Defaults to `$TEMP/appscope`.
