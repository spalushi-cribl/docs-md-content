...
Monitor and troubleshoot your Cribl Edge deployment.
...
- **Process-Level Monitoring**: Delve deeper into specific processes, such as `cribl` processes, to pinpoint resource bottlenecks and optimize performance. For details, see [Processes](explore-edge-linux#processes).
