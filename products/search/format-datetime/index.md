...
The `format_datetime` function formats a [`datetime`](datetime) according to the provided format.
...
`FFFFFFF`|If non-zero, the ten millionths of a second in a date and time value.|2009-06-15T13:45:30.6175425 -> 6175425, 2009-06-15T13:45:30.0001150 -> 0001150
...
This example returns `17-01-29 [09:00:05]`:

```kusto {runSearch=true}
let dt = datetime(2017-01-29 09:00:05);
print v1=format_datetime(dt,'yy-MM-dd [HH:mm:ss]')
```

This example returns `2017-1-29 [9:00:05]`:

```kusto {runSearch=true}
let dt = datetime(2017-01-29 09:00:05);
print v2=format_datetime(dt, 'yyyy-M-dd [H:mm:ss]')
```

This example returns `17-01-29 [09:00:05 AM]`: 

```kusto {runSearch=true}
let dt = datetime(2017-01-29 09:00:05);
print v3=format_datetime(dt, 'yy-MM-dd [hh:mm:ss tt]')
```
