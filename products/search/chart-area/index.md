...
Visualize your search results, using an Area Chart.

---

An **Area** Chart is similar to a Line Chart, except the area representing values is filled in with the selected color.
These are suited for data that accumulates, not so much for highly fluctuating data.


![Area Chart](search-area-chart.png)
{scale="100%"}
