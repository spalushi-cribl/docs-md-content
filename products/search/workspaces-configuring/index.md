...
Add, edit, or delete your Cribl.Cloud [Workspaces](workspaces).
...
1. On the top bar, select your current Workspace name. This opens a modal with a list of all Workspaces to which you have access.
...
{scale="90%" caption="Creating a new Workspace"}

4. Confirm by selecting **Save**.

The Workspace can take up to several minutes to spin up. While the process continues, you can navigate away and keep
working with your Cribl.Cloud instance as usual.
