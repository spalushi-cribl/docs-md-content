# Distributed Agents Reference Architecture
...
> Download an editable version of this diagram in [SVG](/downloads/ref-arch-many-agents.svg) or [draw.io](/downloads/ref-arch-many-agents.drawio) format. Download Cribl stencils [here](https://cribl.io/wp-content/uploads/2022/07/Cribl-Stencil-Pack-ALL.zip).
>
{.box .success}
